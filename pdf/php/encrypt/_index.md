...
{{% blocks/products/pf/agp/feature-section-col title="Steps to encrypt PDF via Cloud PHP SDK" %}}
...
1. Encrypting it with a user and owner password using AESx256 encryption.
1. Downloading the protected file back to the local system.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Encrypt PDF using PHP" offSpacer="" %}}
...
Encrypt PDF documents with [Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/).
