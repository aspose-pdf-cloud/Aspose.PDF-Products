...
{{% blocks/products/pf/agp/code-block title="This sample code shows updating Metadata from the PDF documents - PHP" offSpacer="" %}}
...
+ You can try out our [free App](https://products.aspose.app/pdf/metadata) to update metadata into PDF files online and test the functionality.
