---
title: Delete images in PDF documents via Aspose.Pdf Cloud PHP SDK
url: /php/images/remove
description: Sample code for deleting images in PDF document using Cloud PHP SDK. Use API example code for working with images in PDF documents with Aspose.PDF Cloud PHP SDK.
lastmod: "2024-11-03"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Delete images in PDF documents via Cloud PHP SDK" h2="API for working with images in PDF documents with Aspose.PDF Cloud PHP SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" >}}
...
{{% blocks/products/pf/agp/content h2="How to delete images in PDF documents using Cloud PHP SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to delete image in PDF documents via Cloud PHP SDK" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF Cloud PHP developers can easily delete images in PDF documents. Developers need just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Load your Application Secret and Key from the JSON file or set credentials in another way
1. Create an object to connect to the Cloud API
1. Type page number and image number which You need to delete 
1. Perform the deleting image action for PDf document using <b>deleteImage(...)</b> function as shown in the next example
1. Check the result of deleting inage action
...
{{% blocks/products/pf/agp/code-block title="This sample code shows deleting image in PDF document using PDF Cloud PHP SDK" offSpacer="" %}}

```php

<?php

$name = 'Youe-Pdf-Document.pdf';             // Replace with Your Pdf document file
...
<!-- aboutfile Starts -->
{{< blocks/products/pf/agp/demobox sectionTitle="Online PDF Insert images Live Demos" sectionDescription="Deleting image into PDF documents right now by visiting our [Live Demos website](https://products.aspose.app/pdf/editor). The live demo has the following benefits" >}}
