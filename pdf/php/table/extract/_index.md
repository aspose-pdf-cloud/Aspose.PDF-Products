...
{{% blocks/products/pf/agp/feature-section-col title="Steps to extract Tables from PDF via Cloud PHP SDK" %}}
...
1. Retrieve Information About All Tables
1. Retrieve a Specific Table by ID
1. Print the details of the table
...
{{% blocks/products/pf/agp/code-block title="Extract Tables from PDF using PHP" offSpacer="" %}}
...
Extract the Tables from PDF documents with [Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/).
