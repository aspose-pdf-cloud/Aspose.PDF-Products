...
{{% blocks/products/pf/agp/feature-section-col title="Steps to add Image in Footer of PDF via Cloud PHP SDK" %}}
...
1. Modifies the PDF by adding a footer image
...
{{% blocks/products/pf/agp/code-block title="Add Image in Footer of PDF using PHP" offSpacer="" %}}
