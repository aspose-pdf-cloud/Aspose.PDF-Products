---
title: クラウド .NET SDK を介して PNG を PDF に変換
url: net/conversion/png-to-pdf/
description: Aspose.PDF Cloud SDK for .NET を使用して PNG 画像を PDF に変換。画像資産からポータブルドキュメントを作成。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET SDK で PNG を PDF に変換" h2="Aspose.PDF Cloud .NET SDK で PNG ドキュメントを PDF を含む複数の形式にエクスポート" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="SDK for .NET を使用して PNG を PDF に変換する方法" %}}

PNG を PDF に変換するために使用するのは
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
このクラウド SDK を使用すると、C#、ASP.NET、その他の .NET 言語を使用して、さまざまなクラウドプラットフォーム向けのクラウドベースの PDF 作成、編集、変換アプリを簡単に構築できます。開く
...
{{% blocks/products/pf/agp/feature-section-col title=".NET SDK を介して PNG を PDF に変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud 開発者は、わずか数行のコードで PNG ファイルを簡単に読み込み、PDF に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. アプリケーションのシークレットとキーを使用して新しい構成オブジェクトを作成する
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは PNG を PDF に変換する Cloud .NET SDK の変換を示しています" offSpacer="" %}}
