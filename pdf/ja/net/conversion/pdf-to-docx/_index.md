---
title: PDFをMicrosoft Word DOCXに変換するクラウド.NET SDK
url: net/conversion/pdf-to-docx/
description: Aspose.PDF Cloud SDK for .NETを使用して、PDFを編集可能なDOCXドキュメントに変換します。レイアウトとテキスト構造を保持します。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET SDKでPDFをDOCXに変換" h2="Aspose.PDF Cloud .NET SDKでPDFドキュメントをDOCX形式に変換" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="SDK for .NETを使用してPDFをDOCXに変換する方法" %}}

PDFをDOCXに変換するために、私たちは
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
このクラウドSDKを使用することで、C#、ASP.NET、その他の.NET言語で、さまざまなクラウドプラットフォーム向けのPDFクリエーター、エディター、コンバーターアプリを簡単に構築できます。開く
...
{{% blocks/products/pf/agp/feature-section-col title=".NET SDKを介してPDFをDOCXに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloudの開発者は、わずか数行のコードでPDFをDOCXファイルに簡単にロード＆変換できます。
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードはPDFからDOCXへのクラウド.NET SDK変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-svg/" name="PDF から SVG" description="スケーラブルベクターグラフィック" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/svg-to-pdf/" name="SVG から PDF" description="スケーラブルベクターグラフィック" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/text-to-pdf/" name="テキストから PDF" description="テキストドキュメント" >}}
