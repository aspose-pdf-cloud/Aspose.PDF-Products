---
title: PDFをEPUBにクラウド.NET SDKで変換
url: net/conversion/pdf-to-epub/
description: Aspose.PDF Cloud SDK for .NETを使用してPDFドキュメントをEPUB電子書籍に変換します。モバイル読書のためにコンテンツを再フローします。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET SDKでPDFをEPUBに変換" h2="Aspose.PDF Cloud .NET SDKを使用してPDFドキュメントをEPUB形式に変換" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="SDK for .NETを使用してPDFをEPUBに変換する方法" %}}

PDFをEPUBに変換するために使用するのは、
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
このCloud SDKを使えば、C#、ASP.NET、その他の.NET言語で様々なクラウドプラットフォーム向けのクラウドベースのPDF作成、編集、変換アプリを簡単に構築できます。
[NuGet](https://www.nuget.org/packages/Aspose.Pdf-Cloud)
パッケージマネージャを開き、
Aspose.PDF Cloud
を検索してインストールします。また、パッケージマネージャコンソールから以下のコマンドを使用することもできます。
...
{{% blocks/products/pf/agp/feature-section-col title=".NET SDKでPDFをEPUBに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloudの開発者は、わずか数行のコードでPDFをEPUBファイルに簡単にロードして変換できます。
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードはPDFをEPUBに変換するCloud .NET SDKの例を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/gif-to-pdf/" name="GIF TO PDF" description="グラフィックス交換形式" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-gif/" name="PDF TO GIF" description="グラフィックス交換形式" >}}
