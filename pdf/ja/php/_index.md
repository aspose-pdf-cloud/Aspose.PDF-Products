...
<p>Aspose.PDF Cloud PHP SDKを使用すると、注釈をマーク済み、未マーク、受入済み、拒否済み、キャンセル済み、完了済み、またはなしのさまざまな状態に設定できます。また、PDFドキュメントのスタンプのさまざまなプロパティを設定することもできます。これらのプロパティには、不透明度、回転、配置、インデント、ズーム、その他のさまざまなプロパティが含まれます。</p>
</div>
<div class="col-lg-12">
