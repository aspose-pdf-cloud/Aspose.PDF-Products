---
title: クラウド Java SDK を使用した PDF の回転
url: java/rotate/
description: PDF ページの回転は Aspose.PDF Cloud を使用して実行されます。PDF ファイルを回転させる Java のソースコードをご確認ください。
lastmod: 2025-07-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Java SDK で PDF を回転" h2="Java を使用した PDF 文書のページ回転 API" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="クラウド Java SDK を使用した PDF の回転方法" %}}

PDF 文書を回転させるには、次のものを使用します
...
{{% blocks/products/pf/agp/feature-section-col title="Java SDK を使用した PDF の回転手順" %}}
...
1. ページ回転のパラメータを設定します。
1. 指定したページを希望の角度で回転させます。
1. 変更された PDF をダウンロードします。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Java Cloud SDK を使用した PDF の回転" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java SDK でできること" %}}
...
+ 機能をテストするために、私たちの[無料アプリ](https://products.aspose.app/pdf/)をお試しください。
