---
title: Cloud Node.js SDKを使用してテキストをPDFに変換
url: nodejs/conversion/txt-to-pdf/
description: Aspose.PDF Cloud SDK for Node.jsを使用して、プレーンなTXTファイルを構造化されたPDFに変換します。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js SDKでTXTをPDFに変換" h2="Aspose.PDF Cloud Node.js SDKを使用して、TXTドキュメントをPDFを含む複数の形式にエクスポート" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Node.js SDKを使用してTXTをPDFに変換する方法" %}}

TXTをPDFに変換するために使用するのは
...
{{% blocks/products/pf/agp/feature-section-col title="Node.js経由でTXTをPDFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js開発者は、数行のコードで簡単にTXTファイルをPDFにロード＆変換できます。

{{% /blocks/products/pf/agp/text %}}

1. JSONファイルからまたは別の方法でアプリケーションの秘密とキーをロードする
2. クラウドAPIに接続するためのオブジェクトを作成する
3. ドキュメントファイルをアップロードする
4. putMarkdownInStorageToPdfを使用して変換を実行する
5. 必要に応じて結果をダウンロードする

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="このサンプルコードはTXTをPDFに変換するCloud Node.js SDKの例を示しています" offSpacer="" %}}
