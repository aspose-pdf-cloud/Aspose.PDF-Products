---
title: JPEGをPDFに変換する方法：Cloud Node.js SDKを使用
url: nodejs/conversion/jpeg-to-pdf
description: Node.jsとAspose.PDF Cloud SDKを使用してJPEG画像をPDFドキュメントに変換します。高品質な画像埋め込み。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js SDKでJPEGをPDFに変換" h2="Aspose.PDF Cloud Node.js SDKを使用してJPEGドキュメントをPDFを含む複数の形式にエクスポート" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Node.js SDKを使用してJPEGをPDFに変換する方法" %}}

JPEGをPDFに変換するには、
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
このCloud SDKは、Node.jsプログラマーがNode.jsプログラミング言語を使用して、クラウドベースのPDF作成、注釈、編集、変換アプリを開発するのを支援します。Aspose.PDF REST APIを経由して、
[NPM](https://www.npmjs.com/package/asposepdfcloud)
パッケージマネージャーを開いて、
Aspose.PDF Cloudを検索し、
インストールします。以下のコマンドをパッケージマネージャーコンソールから使用することもできます。
...
{{% blocks/products/pf/agp/feature-section-col title="Node.jsを使用してJPEGをPDFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js開発者は、数行のコードで簡単にJPEGファイルをPDFにロードして変換できます。
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、Cloud Node.js SDKによるJPEGからPDFへの変換を示します" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="他のサポートされている変換" subTitle="以下に示すいくつかを含む、多くの他のファイル形式にMDを変換することもできます。" >}}
