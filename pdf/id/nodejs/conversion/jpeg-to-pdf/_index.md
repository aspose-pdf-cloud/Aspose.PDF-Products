---
title: Konversi JPEG ke PDF melalui Cloud Node.js SDK
url: nodejs/conversion/jpeg-to-pdf
description: Konversi gambar JPEG menjadi dokumen PDF menggunakan Node.js dan Aspose.PDF Cloud SDK. Penyematan gambar berkualitas tinggi.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi JPEG ke PDF dalam Node.js SDK" h2="Ekspor dokumen JPEG ke berbagai format termasuk PDF dengan Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi JPEG ke PDF Menggunakan Node.js SDK" %}}

Untuk mengonversi JPEG ke PDF, kita akan menggunakan
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Cloud SDK ini membantu programmer Node.js dalam mengembangkan aplikasi pembuat, annotator, editor, dan konverter PDF berbasis cloud menggunakan bahasa pemrograman Node.js melalui Aspose.PDF REST API. Buka
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi JPEG ke PDF melalui Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Pengembang Aspose.PDF Cloud Node.js dapat dengan mudah memuat & mengonversi file JPEG ke PDF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat Rahasia Aplikasi dan Kunci Anda dari file JSON atau tetapkan kredensial dengan cara lain
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi JPEG ke PDF SDK Cloud Node.js" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/html-to-pdf/" name="HTML KE PDF" description="Bahasa Markup Hiper Teks" >}}
