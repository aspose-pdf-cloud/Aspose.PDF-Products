---
title: Konversi PDF ke EPUB melalui Cloud Node.js SDK
url: nodejs/conversion/pdf-to-epub/
description: Ekspor file PDF ke format EPUB menggunakan Aspose.PDF Cloud SDK untuk Node.js. Aktifkan tata letak ramah eBook.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi PDF ke EPUB di Node.js SDK" h2="Ekspor dokumen PDF ke berbagai format termasuk EPUB dengan Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PDF ke EPUB Menggunakan Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi PDF ke EPUB melalui Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Pengembang Aspose.PDF Cloud Node.js dapat dengan mudah memuat & mengonversi file PDF ke EPUB hanya dalam beberapa baris kode.
...
1. Lakukan konversi menggunakan getPdfInStorageToEpub
1. Unduh hasilnya jika diperlukan

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi PDF ke EPUB Cloud Node.js SDK" offSpacer="" %}}
