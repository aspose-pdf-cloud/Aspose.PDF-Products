---
title: Konversi PDF ke PDF/A melalui Cloud Node.js SDK
url: nodejs/conversion/pdf-to-pdfa/
description: Arsipkan PDF dalam format PDF/A menggunakan Aspose.PDF Cloud SDK untuk Node.js. Pastikan kepatuhan jangka panjang.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi PDF ke PDF/A dalam Node.js SDK" h2="Ekspor dokumen PDF ke berbagai format termasuk PDF/A dengan Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PDF ke PDF/A Menggunakan Node.js SDK" %}}

Untuk mengonversi PDF ke PDF/A, kita akan menggunakan
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Cloud SDK ini membantu pengembang Node.js dalam mengembangkan aplikasi pembuat, annotator, editor, dan konverter PDF berbasis cloud menggunakan bahasa pemrograman Node.js melalui Aspose.PDF REST API. Buka
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi PDF ke PDF/A melalui Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Pengembang Aspose.PDF Cloud Node.js dapat dengan mudah memuat & mengonversi file PDF ke PDF/A hanya dalam beberapa baris kode.
...
1. Lakukan konversi menggunakan getPdfInStorageToPdfA
1. Unduh hasilnya jika diperlukan

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi PDF ke PDF/A Cloud Node.js SDK" offSpacer="" %}}
