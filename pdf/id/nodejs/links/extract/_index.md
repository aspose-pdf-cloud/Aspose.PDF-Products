---
title: Ekstrak Tautan dari PDF melalui Cloud Node.js SDK
url: nodejs/links/extract/
description: Ekstrak semua hyperlink dari file PDF menggunakan Aspose.PDF Cloud SDK untuk Node.js.
lastmod: 2025-02-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Ekstrak Tautan dari PDF dalam Node.js SDK" h2="Ekstrak Tautan dari Dokumen PDF menggunakan Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Ekstrak Tautan dari PDF melalui Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Ekstrak Tautan menggunakan Node.js" %}}
...
1. Ambil Anotasi Tautan yang diperlukan dari dokumen menggunakan fungsi getPageLinkAnnotation()
1. Lakukan beberapa tindakan setelah berhasil mengambil Anotasi Tautan dari dokumen
1. Unduh hasil jika diperlukan

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Ekstrak Tautan dari PDF menggunakan Node.js" offSpacer="" %}}
...
Ekstrak Tautan dari dokumen PDF dengan [Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/).
