...
Untuk menambahkan anotasi Teks Sorotan ke dalam PDF, kita akan menggunakan
...
1. Buat anotasi sorotan baru dengan posisi, warna, teks, dan gaya yang telah ditentukan.
...
{{% blocks/products/pf/agp/code-block title="Tambahkan Anotasi ke PDF menggunakan Python" offSpacer="" %}}
