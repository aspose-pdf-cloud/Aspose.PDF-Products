...
{{% blocks/products/pf/agp/content h2="Cara menambahkan Tautan ke PDF melalui Cloud Python SDK " %}}

Untuk menambahkan tautan ke dalam PDF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk menambahkan Tautan ke dalam PDF melalui Python SDK" %}}
...
1. Tambahkan anotasi hyperlink baru ke halaman tertentu dalam dokumen PDF

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Tambahkan Tautan ke PDF menggunakan Python" offSpacer="" %}}
...
Tambahkan tautan ke dalam dokumen PDF dengan [Aspose.PDF Cloud Python SDK](https://products.aspose.cloud/pdf/python/).
