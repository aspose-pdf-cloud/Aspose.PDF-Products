---
title: Konversi TIFF ke PDF melalui Cloud .NET SDK
url: net/conversion/tiff-to-pdf/
description: Konversi file gambar TIFF menjadi PDF menggunakan Aspose.PDF Cloud SDK untuk .NET. Andal untuk pengarsipan dokumen yang dipindai.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi TIFF ke PDF di .NET SDK" h2="Ekspor dokumen TIFF ke berbagai format termasuk PDF dengan Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TIFF ke PDF Menggunakan SDK untuk .NET" %}}

Untuk mengonversi TIFF ke PDF, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi TIFF ke PDF melalui .NET SDK" %}}
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi SDK Cloud .NET TIFF ke PDF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-svg/" name="PDF KE SVG" description="Grafik Vektor Skalable" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/svg-to-pdf/" name="SVG KE PDF" description="Grafik Vektor Skalable" >}}
