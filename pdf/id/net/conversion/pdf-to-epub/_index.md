---
title: Konversi PDF ke EPUB melalui Cloud .NET SDK
url: net/conversion/pdf-to-epub/
description: Konversi dokumen PDF menjadi eBook EPUB dengan Aspose.PDF Cloud SDK untuk .NET. Sesuaikan konten untuk membaca di perangkat mobile.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi PDF ke EPUB dalam .NET SDK" h2="Konversi dokumen PDF ke format EPUB dengan Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PDF ke EPUB Menggunakan SDK untuk .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi PDF ke EPUB melalui .NET SDK" %}}
...
{{% blocks/products/pf/agp/code-block title="Kode sampel ini menunjukkan Konversi PDF ke EPUB Cloud .NET SDK" offSpacer="" %}}
