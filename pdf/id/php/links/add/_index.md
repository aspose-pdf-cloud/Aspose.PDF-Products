---
title: Tambahkan Tautan ke PDF melalui Cloud PHP SDK
url: php/links/add/
description: Tambahkan hyperlink ke dokumen PDF menggunakan PHP dan Aspose.PDF Cloud SDK. Buat konten menjadi interaktif.
lastmod: 2024-10-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tambahkan Tautan ke PDF dalam PHP SDK" h2="Tambahkan Tautan dalam dokumen PDF menggunakan Cloud PHP SDK." logoImageSrc="/sdk/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="untuk PHP" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Cara menambahkan Tautan ke PDF melalui Cloud PHP SDK" %}}

Untuk menambahkan Tautan ke dalam PDF, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk menambahkan Tautan ke dalam PDF melalui Cloud PHP" %}}
...
1. Unduh PDF yang Diproses
1. Menambahkan hyperlink yang dapat diklik ke halaman PDF

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Tambahkan Tautan ke PDF menggunakan PHP" offSpacer="" %}}
...
Tambahkan tautan ke dokumen PDF dengan [Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/).
