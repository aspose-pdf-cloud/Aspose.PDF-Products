---
title: Hapus Metadata dalam Dokumen PDF melalui Cloud PHP SDK
url: php/metadata/remove/
description: Hapus metadata sensitif dari file PDF menggunakan PHP dan Aspose.PDF Cloud SDK.
lastmod: 2022-03-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hapus Metadata dari PDF dalam PHP SDK" h2="Hapus metadata dari dokumen PDF menggunakan Cloud PHP SDK." logoImageSrc="/sdk/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="untuk PHP" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Menghapus Metadata dari Dokumen PDF menggunakan Cloud PHP SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk menghapus Metadata via Cloud PHP SDK" %}}

{{% blocks/products/pf/agp/text %}}

Program dasar untuk menghapus metadata dari pdf secara programatis dengan
[Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/)
...
1. Lihat [Panduan Pengembang](https://docs.aspose.cloud/pdf/developer-guide/) untuk menghapus Metadata dari PDF dalam PHP.
1. Lihat [repositori GitHub](https://github.com/aspose-pdf-cloud/aspose-pdf-cloud-php) kami untuk daftar lengkap API beserta contoh kerja.
1. Lihat halaman [Referensi API](https://reference.aspose.cloud/pdf/#/Document) untuk deskripsi parameter API.

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan cara menghapus Metadata dari dokumen PDF menggunakan PHP" offSpacer="" %}}
