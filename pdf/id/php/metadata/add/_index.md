---
title: Tambahkan Metadata melalui Cloud PHP SDK
url: php/metadata/add/
description: Tambahkan metadata ke file PDF di PHP menggunakan Aspose.PDF Cloud SDK. Tandai dokumen agar lebih mudah diindeks dan dicari.
lastmod: 2024-03-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tambahkan Metadata ke PDF di PHP SDK" h2="Tambahkan Metadata ke Dokumen PDF menggunakan Cloud PHP SDK." logoImageSrc="/sdk/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="untuk PHP" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Cara membuat Metadata melalui Cloud PHP SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah membuat Metadata melalui Cloud PHP SDK" %}}

{{% blocks/products/pf/agp/text %}}

Menambahkan metadata ke dalam PDF secara programatis dengan
[Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/)
...
1. Lihat [Panduan Pengembang](https://docs.aspose.cloud/pdf/developer-guide/) untuk membuat Metadata di PDF di PHP.
...
Sangat mudah untuk memulai dengan Aspose.PDF Cloud PHP SDK dan tidak ada yang perlu diinstal. Cukup buat akun di Aspose for Cloud dan dapatkan informasi aplikasi Anda. Setelah Anda memiliki App SID & key, Anda siap menggunakan Aspose.PDF Cloud PHP SDK.
...
{{% blocks/products/pf/agp/code-block title="Buat Properti Metadata XMP di PDF menggunakan PHP" offSpacer="" %}}
...
Bekerja dengan metadata dalam file PDF adalah penting. Metadata seperti bidang judul, penulis, dan tema membantu mengklasifikasikan dokumen, sehingga memudahkan pengelolaan koleksi dokumen besar dengan memberikan gambaran cepat tentang konten tanpa membuka file.
...
+ Anda dapat mencoba [Aplikasi gratis kami](https://products.aspose.app/pdf/metadata) untuk menambahkan metadata ke dalam file PDF secara online dan menguji fungsinya.
