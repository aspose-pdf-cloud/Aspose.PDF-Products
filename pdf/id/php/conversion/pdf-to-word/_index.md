---
title: Konversi PDF ke DOC melalui PHP Cloud SDK
url: php/conversion/pdf-to-word/
description: Ekspor PDF ke format Word (DOCX) dengan PHP menggunakan Aspose.PDF Cloud SDK. Memungkinkan pengeditan dan penggunaan ulang yang mudah.
lastmod: 2024-10-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi PDF ke DOC di PHP SDK" h2="Ekspor Dokumen PDF ke berbagai format termasuk DOC dengan Aspose.PDF Cloud PHP SDK" logoImageSrc="/sdk/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi PDF ke DOC melalui PHP" %}}

{{% blocks/products/pf/agp/text %}}

Pengembang Aspose.PDF Cloud PHP dapat dengan mudah memuat & mengonversi file PDF ke DOC hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi PDF ke DOC Cloud PHP SDK" offSpacer="" %}}
