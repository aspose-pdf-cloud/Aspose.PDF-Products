---
title: Tambahkan Anotasi Garis Bawah pada PDF melalui Cloud Java SDK
url: java/annotations/underline/
description: Masukkan anotasi teks bergaris bawah ke dokumen PDF menggunakan Aspose.PDF Cloud Java SDK.
lastmod: 2025-11-23
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tambahkan anotasi teks bergaris bawah ke dokumen PDF melalui Java SDK" h2="API untuk menambahkan anotasi teks bergaris bawah ke dokumen PDF menggunakan Aspose.PDF Cloud Java SDK." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara menyisipkan anotasi teks bergaris bawah ke dokumen PDF menggunakan Cloud Java SDK " %}}
...
1. Membuat anotasi garis bawah hijau dengan metadata lengkap.
1. Menerapkannya ke halaman tertentu.
1. Menangani respons server.
1. Mengunduh file yang diperbarui.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan penambahan anotasi garis bawah ke dokumen PDF" offSpacer="" %}}
...
Menambahkan anotasi ke PDF memiliki banyak tujuan penting dalam berbagai kasus penggunaan. Salah satu alasan paling umum adalah untuk tinjauan dan umpan balik. Anotasi memungkinkan pengguna menyoroti bagian tertentu dari dokumen, meninggalkan komentar, mengajukan pertanyaan, atau menyarankan perubahan. Hal ini membuat proses tinjauan lebih efisien dan teratur, terutama ketika banyak kolaborator terlibat.
