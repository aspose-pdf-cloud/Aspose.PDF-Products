---
title: Tambahkan Anotasi Coret pada PDF melalui Cloud Java SDK
url: java/annotations/strikeout/
description: Masukkan anotasi teks coret ke dokumen PDF menggunakan Aspose.PDF Cloud Java SDK.
lastmod: 2025-11-23
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tambahkan anotasi teks coret ke dokumen PDF melalui Java SDK" h2="API untuk menambahkan anotasi teks coret ke dokumen PDF menggunakan Aspose.PDF Cloud Java SDK." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara menyisipkan anotasi teks coret ke dokumen PDF menggunakan Cloud Java SDK " %}}

Untuk menambahkan anotasi coret ke dokumen PDF melalui Cloud Java SDK, kita akan menggunakan
...
1. Membuat StrikeOutAnnotation baru dengan properti seperti posisi, warna, dan teks.
1. Menambahkannya ke halaman yang diinginkan menggunakan Aspose.PDF Cloud API.
1. Memvalidasi respons.
1. Mengunduh dokumen yang diperbarui secara lokal.
...
Menambahkan anotasi ke PDF melayani banyak tujuan penting dalam berbagai kasus penggunaan. Salah satu alasan paling umum adalah untuk tinjauan dan umpan balik. Anotasi memungkinkan pengguna menyoroti bagian tertentu dari dokumen, meninggalkan komentar, mengajukan pertanyaan, atau menyarankan perubahan. Hal ini membuat proses peninjauan menjadi lebih efisien dan terorganisir, terutama ketika banyak kolaborator terlibat.
...
+ Anda dapat mencoba [Aplikasi gratis](https://products.aspose.app/pdf/) kami untuk menambahkan anotasi ke file PDF secara daring dan menguji fungsionalitasnya.
