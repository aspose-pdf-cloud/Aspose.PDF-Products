...
{{< blocks/products/pf/upper-banner h1="Ganti bookmark dalam PDF melalui Go SDK" h2="API untuk mengganti bookmark dalam dokumen PDF dengan Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara mengganti bookmark dalam dokumen PDF menggunakan Cloud Go SDK" %}}

Untuk mengganti bookmark dalam dokumen PDF, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk mengganti bookmark menggunakan Go" %}}

{{% blocks/products/pf/agp/text %}}

Pengembang Aspose.PDF Cloud Go dapat dengan mudah mengganti bookmark dalam dokumen PDF. Pengembang hanya memerlukan beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Menyiapkan Parameter
1. Buat bookmark baru dengan properti yang ditentukan
1. Ganti bookmark dalam dokumen PDF menggunakan Aspose PDF Cloud API
1. Cetak bookmark yang diperbarui jika operasi berhasil

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kode sampel ini menunjukkan penggantian bookmark dalam dokumen PDF menggunakan PDF Cloud Go SDK" offSpacer="" %}}
...
+ Anda dapat mencoba [Aplikasi gratis kami](https://products.aspose.app/pdf/) untuk mengganti bookmark dalam file PDF secara online dan menguji fungsionalitasnya.
