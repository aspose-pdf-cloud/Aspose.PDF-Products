...
Untuk menambahkan anotasi ke dokumen PDF, kami akan menggunakan
...
1. Tentukan Anotasi Coretan dengan properti tertentu (nama kustom, persegi panjang pembatas, detail Visual dan posisi).
1. Kirim Anotasi ke Halaman PDF.
1. Unduh dokumen yang telah dimodifikasi jika berhasil.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan penambahan anotasi ke dokumen PDF menggunakan PDF Cloud Go SDK" offSpacer="" %}}
...
Menambahkan anotasi ke PDF memiliki banyak tujuan penting di berbagai kasus penggunaan. Salah satu alasan paling umum adalah untuk tinjauan dan umpan balik. Anotasi memungkinkan pengguna menyoroti bagian tertentu dari dokumen, meninggalkan komentar, mengajukan pertanyaan, atau menyarankan perubahan. Ini membuat proses tinjauan lebih efisien dan terorganisir, terutama ketika melibatkan banyak kolaborator.
