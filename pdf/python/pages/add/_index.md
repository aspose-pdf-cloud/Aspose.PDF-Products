...
description: Aspose.PDF Cloud allows you to add a pages to a PDF Document. Check the Python source code to add a pages into PDF file.
lastmod: "2024-10-19"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Pages to PDF via Cloud Python SDK" h2="Add Pages to PDF Document using Cloud  Python SDK." logoImageSrc="https://products.aspose.cloud/sdk/aspose_pdf-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to add Pages to PDF via Cloud Python SDK " %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to add Pages into PDF via Python SDK" %}}
...
1. Add new page to end of the PDF document

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Add Pages to PDF using Python" offSpacer="" %}}
...
Add the Pages to PDF documents with [Aspose.PDF Cloud Python SDK](https://products.aspose.cloud/pdf/python/).
