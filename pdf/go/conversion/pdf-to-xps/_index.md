...
{{< blocks/products/pf/upper-banner h1="Convert PDF to XPS in Node.js SDK" h2="Export PDF documents to multiple formats including XPS with Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to XPS Using Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to XPS via Node.js" %}}
...
1. Perform the conversion using getPdfInStorageToXps
1. Download the result if needed it

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to XPS Cloud Node.js SDK Conversion" offSpacer="" %}}
