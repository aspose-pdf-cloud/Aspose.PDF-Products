---
title: Convert PDF to Xml via Cloud Go SDK
url: /go/conversion/pdf-to-xml/
description: Convert PDFs to Xml files with Go using Aspose.PDF Cloud.
lastmod: "2025-05-17"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to Xml in Go SDK" h2="Export PDF documents to multiple formats including Xml with Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to Xml Using Go SDK" %}}

 To convert PDF to Xml, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to Xml via Go" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF Cloud Go developers can easily load & convert PDF to Xml in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Uploading a PDF file to Aspose Cloud Storage.
1. Converting the PDF to Xml format.
1. Saving the output Xml in cloud storage.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to Xml Cloud Go SDK Conversion" offSpacer="" %}}
