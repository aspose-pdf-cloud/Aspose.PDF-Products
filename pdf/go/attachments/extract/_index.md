---
title: Extract attachments from PDF documents via Aspose.Pdf Cloud Go SDK
url: /go/attachments/get/
description: Extract PDF attachments using Go and Aspose.PDF Cloud SDK. Access embedded content via API.
lastmod: "2025-05-20"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extract Attachments from PDF in Go SDK" h2="API for extracting attachments in PDF documents with Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to extract attachments from PDF documents using Cloud Go SDK" %}}

 For getting attachments from PDF documents, we'll use
