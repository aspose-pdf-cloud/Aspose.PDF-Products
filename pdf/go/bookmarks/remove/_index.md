...
{{% blocks/products/pf/agp/content h2="How to delete bookmarks in PDF documents using Cloud Go SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to delete bookmarks using Go" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Go developers can easily remove bookmarks from PDF documents. Developers need just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Setting Up Parameters
1. Call the DeleteBookmark method of the Aspose PDF Cloud API to remove the specified bookmark
1. If the operation was successful, print the bookmarks

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="This sample code shows removing bookmarks in PDF document using PDF Cloud Go SDK" offSpacer="" %}}
...
Delete the Bookmarks from PDF documents with [Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/).
