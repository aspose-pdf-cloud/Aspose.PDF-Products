...
{{% blocks/products/pf/agp/content h2="How to Get Page annotations from PDF documents using Cloud Go SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to get Page Annotations using Go" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Go developers can easily get annotations from PDF documents. Developers need just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Uploading the file to cloud storage.
1. Retrieve Annotations from the Page using GetPageAnnotations().
1. Search for Text Annotation.
1. Returns empty result if no match found.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="This sample code shows getting Page Annotations from PDF document using PDF Cloud Go SDK" offSpacer="" %}}
...
+ You can try out our [free App](https://products.aspose.app/pdf/) to get the annotations from PDF files online and test the functionality.
