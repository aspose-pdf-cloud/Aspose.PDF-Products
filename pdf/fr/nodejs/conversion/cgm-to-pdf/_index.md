---
title: Convertir CGM en PDF via Cloud Node.js SDK
url: nodejs/conversion/cgm-to-pdf/
description: Convertir les graphiques vectoriels CGM en PDF via Node.js avec Aspose.PDF Cloud SDK. Préserver la précision et la mise en page.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir CGM en PDF dans Node.js SDK" h2="Exporter les documents CGM vers plusieurs formats, y compris PDF avec Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment Convertir CGM en PDF Utilisant Node.js SDK" %}}

Pour convertir CGM en PDF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour Convertir CGM en PDF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs Aspose.PDF Cloud Node.js peuvent facilement charger et convertir des fichiers CGM en PDF en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Chargez votre Clé et Secret d'Application depuis le fichier JSON ou définissez les identifiants d'une autre manière
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la Conversion CGM en PDF Cloud Node.js SDK" offSpacer="" %}}
