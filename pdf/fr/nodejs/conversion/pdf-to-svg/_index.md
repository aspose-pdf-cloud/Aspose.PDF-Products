---
title: Convertir PDF en SVG via Cloud Node.js SDK
url: nodejs/conversion/pdf-to-svg/
description: Exporter le contenu PDF en images vectorielles SVG à l'aide de Node.js et Aspose.PDF Cloud SDK.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF en SVG dans Node.js SDK" h2="Exporter des documents PDF vers plusieurs formats, y compris SVG avec Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PDF en SVG à l'aide de Node.js SDK" %}}

Pour convertir PDF en SVG, nous utiliserons
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Ce Cloud SDK aide les programmeurs Node.js à développer des applications de création, d'annotation, d'édition et de conversion de PDF basées sur le cloud en utilisant le langage de programmation Node.js via l'API REST Aspose.PDF. Ouvrez
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PDF en SVG via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs Aspose.PDF Cloud Node.js peuvent facilement charger et convertir des fichiers PDF en SVG en quelques lignes de code.
...
1. Effectuez la conversion en utilisant getPdfInStorageToSvg
1. Téléchargez le résultat si nécessaire

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PDF en SVG Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF VERS XLSX" description="Fichier Tableur Microsoft Excel Open XML Format" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/text-to-pdf/" name="TEXTE VERS PDF" description="Document Textuel" >}}
