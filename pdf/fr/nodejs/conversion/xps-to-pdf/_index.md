---
title: Convertir XPS en PDF via Cloud Node.js SDK
url: nodejs/conversion/xps-to-pdf/
description: Convertissez des documents XPS en PDF avec Node.js et Aspose.PDF Cloud. Améliorez l'accessibilité et la compatibilité des fichiers.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir XPS en PDF dans Node.js SDK" h2="Exportez des documents XPS vers plusieurs formats, y compris PDF avec Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XPS en PDF en utilisant Node.js SDK" %}}

Pour convertir XPS en PDF, nous utiliserons
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Ce SDK Cloud aide les programmeurs Node.js à développer des applications basées sur le cloud pour créer, annoter, éditer et convertir des PDF en utilisant le langage de programmation Node.js via Aspose.PDF REST API. Ouvrez
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XPS en PDF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs Aspose.PDF Cloud Node.js peuvent facilement charger et convertir des fichiers XPS en PDF en seulement quelques lignes de code.
...
1. Effectuez la conversion en utilisant putXpsInStorageToPdf
1. Téléchargez le résultat si nécessaire

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion XPS en PDF Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/emf-to-pdf/" name="EMF EN PDF" description="Document Office 2007+ Words" >}}
