---
title: Convertir PDF en BMP via Cloud Node.js SDK
url: nodejs/conversion/pdf-to-bmp/
description: Convertir le format PDF en image BMP avec Aspose.PDF Cloud SDK pour Node.js. Sortie d'image haute résolution.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF en BMP dans Node.js SDK" h2="Exporter des documents PDF vers plusieurs formats, y compris BMP, avec Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PDF en BMP en utilisant Node.js SDK" %}}

Pour convertir un PDF en BMP, nous utiliserons
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Ce Cloud SDK aide les programmeurs Node.js à développer des applications de création, d'annotation, d'édition et de conversion de PDF basées sur le cloud en utilisant le langage de programmation Node.js via Aspose.PDF REST API. Ouvrir
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PDF en BMP via Node.js" %}}
...
1. Effectuez la conversion en utilisant getPageConvertToBmp
1. Téléchargez le résultat si besoin

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Ce code exemple montre la conversion PDF en BMP avec le Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Autres conversions prises en charge" subTitle="Vous pouvez également convertir MD en de nombreux autres formats de fichiers, notamment quelques-uns listés ci-dessous." >}}
