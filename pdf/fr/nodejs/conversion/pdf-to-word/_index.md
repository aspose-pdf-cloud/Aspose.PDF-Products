---
title: Convertir PDF en DOC via Cloud Node.js SDK
url: nodejs/conversion/pdf-to-word/
description: Convertissez des PDF en documents Word éditables en utilisant Aspose.PDF Cloud SDK pour Node.js.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF en DOC dans Node.js SDK" h2="Exportez des documents PDF vers plusieurs formats, y compris DOC avec Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PDF en DOC en utilisant Node.js SDK" %}}
...
Aspose.PDF Cloud,
et installez. Vous pouvez également utiliser la commande suivante à partir de la console de gestion des paquets.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PDF en DOC via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs Aspose.PDF Cloud Node.js peuvent facilement charger et convertir des fichiers PDF en DOC en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Chargez votre Application Secret et Key depuis le fichier JSON ou définissez les identifiants d'une autre manière
...
{{% blocks/products/pf/agp/code-block title="Ce code exemple montre la conversion du Cloud Node.js SDK de PDF en DOC" offSpacer="" %}}
