---
title: Convertir du texte en PDF via Cloud Node.js SDK
url: nodejs/conversion/txt-to-pdf/
description: Transformez des fichiers TXT simples en PDF bien structurés en utilisant Aspose.PDF Cloud SDK pour Node.js.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir TXT en PDF dans Node.js SDK" h2="Exportez des documents TXT vers plusieurs formats, y compris PDF, avec Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TXT en PDF en utilisant Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TXT en PDF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs Aspose.PDF Cloud Node.js peuvent facilement charger et convertir des fichiers TXT en PDF en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Chargez votre clé secrète et clé d'application à partir du fichier JSON ou configurez les identifiants d'une autre manière
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion TXT en PDF Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-html/" name="PDF VERS HTML" description="Hyper Texte Markup Language" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF VERS XLSX" description="Fichier Feuille de Calcul Microsoft Excel Open XML Format" >}}
