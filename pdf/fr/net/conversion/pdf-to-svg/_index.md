---
title: Convertir PDF en SVG via Cloud .NET SDK
url: net/conversion/pdf-to-svg/
description: Convertissez des fichiers PDF en images SVG évolutives en utilisant Aspose.PDF Cloud SDK pour .NET.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF en SVG dans .NET SDK" h2="Convertir des documents PDF au format SVG avec Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PDF en SVG en utilisant SDK pour .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PDF en SVG via .NET SDK" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PDF en SVG via Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/gif-to-pdf/" name="GIF EN PDF" description="Format Graphical Interchange" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-gif/" name="PDF EN GIF" description="Format Graphical Interchange" >}}
