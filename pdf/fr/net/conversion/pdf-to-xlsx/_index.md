---
title: Convertir PDF en Microsoft Excel XLSX via Cloud .NET SDK
url: net/conversion/pdf-to-xlsx/
description: Convertir PDF en Excel XLSX avec Aspose.PDF Cloud SDK pour .NET. Extraction de données structurées simplifiée.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF en XLSX dans .NET SDK" h2="Convertir des documents PDF en format XLSX avec Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PDF en XLSX à l'aide du SDK pour .NET" %}}

Afin de convertir PDF en XLSX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PDF en XLSX via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs d'Aspose.PDF Cloud peuvent facilement charger et convertir des fichiers PDF en XLSX en seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Ce code d'exemple montre la conversion PDF en XLSX via Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/emf-to-pdf/" name="EMF EN PDF" description="Format de Metafile Amélioré" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-emf/" name="PDF EN EMF" description="Format de Metafile Amélioré" >}}
