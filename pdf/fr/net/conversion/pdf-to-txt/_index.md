---
title: Convertir PDF en TXT via Cloud .NET SDK
url: net/conversion/pdf-to-txt/
description: Exporter du texte du format PDF vers le format TXT en utilisant Aspose.PDF Cloud SDK pour .NET. Sortie légère et consultable.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF en TXT dans .NET SDK" h2="Convertir des documents PDF en format TXT avec Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PDF en TXT en utilisant SDK pour .NET" %}}

Afin de convertir PDF en TXT, nous utiliserons
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
Ce SDK Cloud vous permet de créer facilement des applications cloud pour créer, éditer et convertir des PDF en C#, ASP.NET, ou d'autres langages .NET pour diverses plateformes cloud. Ouvrez
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PDF en TXT via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs Aspose.PDF Cloud peuvent facilement charger et convertir des fichiers PDF en TXT en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PDF en TXT Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Autres conversions supportées" subTitle="Vous pouvez également convertir beaucoup d'autres formats de fichiers" >}}
