---
title: Convertir EPUB en PDF via Cloud .NET SDK
url: net/conversion/epub-to-pdf/
description: Transformez des livres électroniques EPUB en PDF avec Aspose.PDF Cloud SDK pour .NET. Idéal pour les flux de travail de publication numérique.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir EPUB en PDF dans .NET SDK" h2="Exportez des documents EPUB vers plusieurs formats, y compris PDF, avec Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir EPUB en PDF en utilisant SDK pour .NET" %}}

Afin de convertir EPUB en PDF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir EPUB en PDF via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs d'Aspose.PDF Cloud peuvent facilement charger et convertir des fichiers EPUB en PDF en seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion EPUB en PDF Cloud .NET SDK" offSpacer="" %}}
