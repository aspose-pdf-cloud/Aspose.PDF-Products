---
title: Convertir PDF en EPUB via Cloud .NET SDK
url: net/conversion/pdf-to-epub/
description: Convertissez des documents PDF en livres électroniques EPUB avec Aspose.PDF Cloud SDK pour .NET. Refluez le contenu pour la lecture mobile.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF en EPUB dans .NET SDK" h2="Convertissez des documents PDF au format EPUB avec Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PDF en EPUB en utilisant SDK pour .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PDF en EPUB via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs Aspose.PDF Cloud peuvent facilement charger et convertir des fichiers PDF en EPUB en seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Ce code d'exemple montre la conversion PDF en EPUB avec Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/emf-to-pdf/" name="EMF EN PDF" description="Format de fichier métafichier amélioré" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-emf/" name="PDF EN EMF" description="Format de fichier métafichier amélioré" >}}
