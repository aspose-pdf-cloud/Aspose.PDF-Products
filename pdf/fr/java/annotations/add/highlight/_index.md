---
title: Ajouter des annotations de texte en surbrillance aux PDF via le SDK Java Cloud
url: java/annotations/highlight/
description: Insérer des annotations de texte en surbrillance dans les documents PDF à l'aide d'Aspose.PDF Cloud SDK Java.
lastmod: 2025-11-23
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Ajouter des annotations de texte en surbrillance aux documents PDF via le SDK Java" h2="API pour ajouter des annotations de texte en surbrillance aux documents PDF à l'aide d'Aspose.PDF Cloud SDK Java." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment insérer des annotations de texte en surbrillance dans les documents PDF à l'aide du SDK Java Cloud " %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter le repository Aspose Cloud" offSpacer="true" %}}
...
1. Créez une nouvelle annotation de surbrillance avec une position, une couleur, un texte et un style définis.
1. Envoyez l'annotation à la page spécifiée à l'aide de l'API Aspose Cloud.
