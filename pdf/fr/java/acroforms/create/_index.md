---
title: Création d'un AcroForm via le SDK Java Cloud
url: java/acroforms/add/
description: Ajoutez de nouveaux champs de formulaire aux PDF avec Aspose.PDF Cloud pour Java. Créez des AcroForms interactifs en quelques secondes.
lastmod: 2025-11-21
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Créer des formulaires PDF dans le SDK Java" h2="Ajoutez des champs de formulaire à un document PDF dans des applications Java pour créer un document remplissable." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer un AcroForm via le SDK Java Cloud " %}}

Afin de créer un AcroForm via le SDK Java Cloud, nous allons utiliser
[Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/)
Ce SDK Cloud vous permet de créer facilement des applications de création, édition et conversion de PDF basées sur le cloud en langage Java pour diverses plateformes cloud. Ouvrez
...
{{% blocks/products/pf/agp/code-block title="Ce code d'exemple montre la création d'AcroForms dans des documents PDF" offSpacer="" %}}
...
+ Vous pouvez essayer notre [application gratuite](https://products.aspose.app/pdf/xfa) pour ajouter les AcroForms aux fichiers PDF en ligne et tester les fonctionnalités.
