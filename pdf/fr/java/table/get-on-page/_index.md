---
title: Obtenir des tables sur la page depuis un PDF via le SDK Java Cloud
url: java/table/get-on-page/
description: Extraire les tables sur la page à partir de PDF en utilisant Aspose.PDF Cloud SDK pour Java. Extraire toutes les tables sur la page des documents.
lastmod: 2025-11-10
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Obtenir des tables sur la page à partir d'un PDF avec le SDK Java" h2="Obtenez toutes les tables sur la page d'un document PDF en utilisant l'API Java côté serveur." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment extraire des tables sur la page depuis un PDF via le SDK Java Cloud " %}}

Afin d'extraire des tables sur la page depuis un PDF via le SDK Java Cloud, nous utiliserons
[Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/)
Ce SDK Cloud vous permet de créer facilement des applications cloud de création, d'édition et de conversion de PDF en C#, ASPJava ou d'autres langages Java pour diverses plateformes cloud. Ouvrez
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour extraire des tables sur la page depuis un PDF via le SDK Java" %}}
...
1. Extrayez les tables sur la page du PDF stocké dans le cloud en utilisant la fonction getPageTables.
1. Vérifiez la réponse et consignez le résultat.
1. Si l'opération a réussi, affichez les tables

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Ce code d'exemple montre l'extraction de tables sur la page à partir de documents PDF" offSpacer="" %}}
...
Obtenez toutes les tables sur la page à partir de documents PDF avec [Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/).
...
+ Extraire divers éléments des fichiers PDF & rendre les documents PDF optimisés.
