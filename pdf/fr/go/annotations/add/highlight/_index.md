...
{{< blocks/products/pf/upper-banner h1="Ajouter des annotations de texte surligné à PDF via Go SDK" h2="API pour ajouter des annotations aux documents PDF avec Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
1. Création d'une annotation surlignée avec des propriétés spécifiques (boîte englobante, couleur, texte).
1. Envoi de l'annotation à ajouter à une page via Aspose.PDF Cloud.
1. Téléchargement du document modifié si réussi.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Ce code exemple montre l'ajout d'annotations au document PDF en utilisant PDF Cloud Go SDK" offSpacer="" %}}
...
+ Vous pouvez essayer notre [application gratuite](https://products.aspose.app/pdf/) pour ajouter les annotations dans les fichiers PDF en ligne et tester la fonctionnalité.
