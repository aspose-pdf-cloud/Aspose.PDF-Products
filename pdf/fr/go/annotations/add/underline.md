---
title: Ajouter des annotations de texte souligné via Cloud Go SDK
url: go/annotations/underline/
description: Ajoutez des annotations de texte souligné aux PDF à l'aide de Aspose.PDF Cloud SDK pour Go.
lastmod: 2025-07-20
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Ajouter des annotations de texte souligné au PDF via Go SDK" h2="API pour ajouter des annotations aux documents PDF avec Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment ajouter des annotations aux documents PDF à l'aide de Cloud Go SDK" %}}

Pour ajouter des annotations de texte souligné aux documents PDF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter des annotations avec Go" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs Aspose.PDF Cloud Go peuvent facilement ajouter des annotations aux documents PDF. Les développeurs ont besoin de seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Téléchargement du fichier sur le stockage cloud.
1. Définir l'annotation soulignée (couleur, positionnement, etc.).
1. Composer l'objet d'annotation avec UnderlineAnnotation.
1. Publier l'annotation sur la page PDF.
1. Télécharger le document modifié en cas de succès.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Ce code d'exemple montre comment ajouter des annotations de texte souligné au document PDF en utilisant PDF Cloud Go SDK" offSpacer="" %}}
...
Ajouter des annotations à un PDF sert de nombreux objectifs importants dans différents cas d'utilisation. L'une des raisons les plus courantes est pour l'examen et la rétroaction. Les annotations permettent aux utilisateurs de mettre en évidence des parties spécifiques d'un document, de laisser des commentaires, de poser des questions ou de suggérer des modifications. Cela rend le processus de révision plus efficace et organisé, surtout lorsque plusieurs collaborateurs sont impliqués.
Ajoutez les annotations aux documents PDF avec [Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/).
...
+ Vous pouvez essayer notre [application gratuite](https://products.aspose.app/pdf/) pour ajouter les annotations dans des fichiers PDF en ligne et tester la fonctionnalité.
