---
title: Ajouter du texte dans l'en-tête d'un PDF via Cloud Python SDK
url: python/header/text/
description: Insérez du texte d'en-tête dans des PDF en utilisant Python et Aspose.PDF Cloud SDK. Automatisez la génération de rapports.
lastmod: 2024-10-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Ajouter du texte à l'en-tête du PDF dans Python SDK" h2="API pour travailler avec le texte dans l'en-tête des documents PDF en utilisant Cloud Python SDK." logoImageSrc="https://products.aspose.cloud/sdk/aspose_pdf-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="pour Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Comment ajouter du texte dans l'en-tête d'un PDF via Cloud Python SDK " %}}

Pour ajouter du texte dans l'en-tête d'un PDF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter du texte dans l'en-tête via Python" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs Aspose.PDF Cloud peuvent facilement charger et ajouter du texte dans l'en-tête d'un PDF en seulement quelques lignes de code.
...
1. Ajoutez un nouvel en-tête de texte à la page sur le document PDF

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Ajouter du texte dans l'en-tête du PDF en utilisant Python" offSpacer="" %}}
