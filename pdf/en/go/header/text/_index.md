---
title: Add Text to Header of PDFs via Cloud Go SDK
url: go/header/text/
...
{{% blocks/products/pf/agp/content h2="How to append Text to Header of PDF documents using Cloud Go SDK" %}}
