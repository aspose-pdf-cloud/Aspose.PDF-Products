...
{{% blocks/products/pf/agp/content h2="How to delete watermarks in PDF documents using Cloud Go SDK" %}}

 For removing watermarks from PDF documents, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to delete watermarks using Go" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Go developers can easily remove watermarks from PDF documents. Developers need just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Define the DeleteImageWatermarks Function
1. Upload the Original PDF to Cloud Storage
1. Prepare API Request Parameters
1. Iterate Over the watermarkIds and Delete Each Image
1. Download the Updated PDF

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="This sample code shows removing watermarks in PDF document using PDF Cloud Go SDK" offSpacer="" %}}
...
+ You can try out our [free App](https://products.aspose.app/pdf/) to delete the watermarks in PDF files online and test the functionality.
