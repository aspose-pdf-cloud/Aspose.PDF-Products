---
title: Delete Tables from PDF via Cloud Go SDK 
url: go/table/delete/
description: Delete tables from PDF documents in Go using Aspose.PDF Cloud SDK.
lastmod: "2025-08-19"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Remove Tables in PDF via Go SDK" h2="API for removing Tables from PDF documents with Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to delete Tables in PDF documents using Cloud Go SDK" %}}

 For removing tables from PDF documents, we'll use
...
1. Define the DeleteTablesOnPage Function
1. Upload the PDF File to Aspose Cloud
1. Set the Request Parameters
1. Call the API to Delete All Tables on the Specified Page
1. Handle the Response
1. Download the Updated PDF Document

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="This sample code shows removing tables in PDF document using PDF Cloud Go SDK" offSpacer="" %}}
...
+ You can try out our [free App](https://products.aspose.app/pdf/) to delete the tables in PDF files online and test the functionality.
