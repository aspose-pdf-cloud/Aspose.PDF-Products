...
{{% blocks/products/pf/agp/content h2="How to encrypt PDF via Cloud Go SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to encrypt PDF via Go" %}}
...
1. Upload the PDF.
1. Encrypt PDF using the PostEncryptDocumentInStorage method.
1. Download the Encrypted PDF.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Encrypt PDF using Cloud Go SDK" offSpacer="" %}}
...
Encrypt PDF documents with [Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/).
