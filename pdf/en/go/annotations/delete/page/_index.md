---
title: Delete annotations from PDF pages via Cloud Go SDK
url: go/annotations/page/delete
description: Delete annotations from PDF document pages using Aspose.PDF Cloud SDK for Go.
lastmod: "2025-07-20"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Delete annotations from PDF docuemnt pages via Go SDK" h2="API for removing annotations from PDF document pages with Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to delete annotations from PDF document pages using Cloud Go SDK" %}}
