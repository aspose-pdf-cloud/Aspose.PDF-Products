...
{{% blocks/products/pf/agp/content h2="How to replace text annotations in PDF documents using Cloud Go SDK" %}}

 For replacing annotations to PDF documents, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to replace annotations using Go" %}}
...
1. getAnnotation fetches a text annotation by ID from a PDF stored in the cloud.
1. ModifyAnnotation updates the contents and icon of that annotation.
1. After modification, the updated PDF is downloaded locally.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="This sample code shows replacing Text Annotations in PDF document using PDF Cloud Go SDK" offSpacer="" %}}
...
+ You can try out our [free App](https://products.aspose.app/pdf/) to replace the annotations in PDF files online and test the functionality.
