...
{{% blocks/products/pf/agp/content h2="How to append strikeout text annotations to PDF documents using Cloud Go SDK" %}}
...
1. Define the Strikeout Annotation with specific properties (custom name, bounding rectangle, Visual and positioning details).
