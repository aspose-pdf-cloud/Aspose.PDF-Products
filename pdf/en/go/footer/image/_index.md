...
{{< blocks/products/pf/upper-banner h1="Add Image to PDF document footer via Go SDK" h2="API for adding an image to the footer of a PDF document using Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to append Image Footer to PDF documents using Cloud Go SDK" %}}
