---
title: Add Text in Footer of PDF via Cloud Go SDK
url: go/footer/text/
description: Insert text-based footers in PDFs using Go with Aspose.PDF Cloud SDK.
lastmod: "2025-05-20"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Text in Footer of PDF via Go SDK" h2="API for adding Images in Footer of PDF documents with Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to append Text in Footer of PDF documents using Cloud Go SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to add Text in Footer of PDF using Go" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Go developers can easily append Text in Footer of PDF documents. Developers need just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Configure the Text Footer.
1. Apply the Footer to the Document with the PostDocumentTextFooter method 

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="This sample code shows adding Text in Footer of PDF document using PDF Cloud Go SDK" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Work with the Footer via Go SDK" %}}
...
Add the Footer into PDF documents with [Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/).
