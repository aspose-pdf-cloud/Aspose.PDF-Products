---
title: Extract Images from PDF via Cloud Go SDK 
url: go/images/extract-all/
description: Extract all images from a PDF using Aspose.PDF Cloud SDK in Go. Process or analyze embedded visuals.
lastmod: "2026-02-03"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extract Image from PDF in Go SDK" h2="Extract Images from PDF Document using Cloud Go SDK." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Extract Images from PDF via Go SDK" %}}

 To extract images from PDF via Cloud Go SDK, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to get images from PDF using Go" %}}
...
```go
    ...
    func GetImages() {
        ...
        response, httpResponse, err := pdfApi.GetImages(storageDocumentName, 1, args)
        if err != nil {
            fmt.Println(err.Error())
        } else if httpResponse.StatusCode < 200 || httpResponse.StatusCode > 299 {
            fmt.Println("GetImages()): Failed to extract images from the document.")
        } else {
            for _, o := range response.Images.List {
                fmt.Println(o.Id, o.Rectangle)
            }
        }
    }
```
