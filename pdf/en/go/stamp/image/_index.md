...
{{< blocks/products/pf/upper-banner h1="Add Image Stamp to a specific page of a PDF via Go SDK" h2="API for adding Images to PDF pages with Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to append image stamp to PDF pages using Cloud Go SDK" %}}

 For adding image stamp to PDF documents, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to add image stamp to PDF using Go" %}}
...
1. Creates an image stamp with specified size and alignment.
1. Adds the image stamp to the desired PDF page.
1. Download the stamped PDF.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="This sample code shows adding image stamp to PDF document using PDF Cloud Go SDK" offSpacer="" %}}
