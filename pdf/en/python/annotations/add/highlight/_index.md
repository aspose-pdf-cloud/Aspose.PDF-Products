...
description: Append highlight text annotations to PDF documents using Aspose.PDF Cloud Python SDK.
lastmod: "2025-07-20"
---
...
{{% blocks/products/pf/agp/content h2="How to add highlight text annotations to PDF documents via Python SDK " %}}
