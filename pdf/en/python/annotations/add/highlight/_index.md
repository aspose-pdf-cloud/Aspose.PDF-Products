...
```python
    ...
    from asposepdfcloud import PdfApi, ApiClient, HighlightAnnotation, Rectangle, Color, AnnotationFlags, HorizontalAlignment, Point, VerticalAlignment
    import shutil
    import os
    import json
    ...
    class PdfAddHighlightAnnotations:
        ...
        def append_highlight_annotation(self):
            ...
            if self.pdf_api:
                ...
                try:
                    response = self.pdf_api.post_page_highlight_annotations(storageDocumentName, page_number=1, annotations=[new_annotation], **args)
                    if response.code == 200:
                        ...
                        logging.info(f"append_highlight_annotation(): annotation added to the document '{outputFileName}'.")
                    else:
