...
{{% blocks/products/pf/agp/content h2="How to insert highlight text annotations to PDF documents using Cloud Java SDK " %}}

 In order to add annotations to PDF documents via Cloud Java SDK , we'll use
