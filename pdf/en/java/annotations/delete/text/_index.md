...
{{% blocks/products/pf/agp/content h2="How to delete text annotations from PDF documents using Cloud Java SDK " %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to remove annotations using Java SDK" %}}
...
1. Deletes a specific annotation using deleteAnnotation().
...
{{% blocks/products/pf/agp/code-block title="This sample code shows removing Text Annotations from PDF document via Java" offSpacer="" %}}
