---
title: Appending Bookmark via Cloud Java SDK 
url: java/bookmarks/add/
description: Add bookmark to PDF files using Aspose.PDF Cloud SDK for Java. Enhance discoverability and indexing.
lastmod: "2025-11-22"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Bookmarks to PDF in Java SDK" h2="Add a Bookmark to a PDF Document using server-side Java API." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to create Bookmark via Cloud Java SDK " %}}

 In order to create a Bookmark via Cloud Java SDK , we'll use
...
Add the Bookmarks into PDF documents with [Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/).
