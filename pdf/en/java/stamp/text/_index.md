---
title: Add Text Stamps to PDFs via Cloud Java SDK
url: java/stamp/text/
description: Insert text stamps into PDFs with Aspose.PDF Cloud SDK for Java.
lastmod: "2026-01-03"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Text Stamp to PDF documents via Java SDK" h2="API for adding PDF Document page text stamps using Aspose.PDF Cloud SDK for Java" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to add Text Stamp into page of PDF documents via Java SDK" %}}

In order to add Text Stamp to PDF via Cloud Java SDK, we'll use
