---
title: Remove Stamp from PDFs via Cloud Java SDK
url: java/stamp/remove/
description: Delete stamps from PDF documents using Java and Aspose.PDF Cloud SDK.
lastmod: "2026-01-03"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Remove Stamp from PDF documents via Java SDK" h2="API for deleting Stamp from PDF Documents using Aspose.PDF Cloud Java SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to delete Stamp in PDF document pages via Java SDK" %}}

In order to remove Stamp in PDF via Cloud Java SDK, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to remove Stamps via Cloud Java" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud developers can easily remove Stamp from PDF in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Create an object to connect to the Pdf.Cloud API
1. Upload your document file
1. Delete stamp from the document using deleteDocumentStamps() function
...
{{% blocks/products/pf/agp/code-block title="This sample code shows deleting Stamps using Java" offSpacer="" %}}
...
```java
    ...
    public class StampDelete {
        public static void Remove() {
            ...
            String PDF_DOCUMENT       = "sample_stamps_1.pdf";
            String PDF_OUTPUT         = "stamps_deletet_output.pdf";
            ...
            try {
                ...
                AsposeResponse response = pdfApi.deleteDocumentStamps(PDF_DOCUMENT, null, REMOTE_FOLDER, null);
                if (response.getCode() != 200)
                    System.err.println("Error: unexpected error when deleting stamps! '" + response.getStatus() + "'");
                else{
