---
title: Resize PDF docuemnt pages via Cloud Java SDK 
url: java/resize/
description: Resize PDF document is performed using Aspose.PDF Cloud. Check the Java source code to resize PDF file pages.
lastmod: "2025-07-19"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Resize PDF docuemnt pages via Java SDK" h2="API for resizing PDF document pages using Java." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to resize PDF docuemnt pages via Cloud Java SDK " %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to resize PDF using Java SDK" %}}
...
{{% blocks/products/pf/agp/code-block title="Resize PDF using Java Cloud SDK" offSpacer="" %}}
