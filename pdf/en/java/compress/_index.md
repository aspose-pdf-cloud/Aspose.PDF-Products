---
title: Compress PDF via Cloud Java SDK 
url: java/compress/
description: Aspose.PDF Cloud allows you to optimize PDF Document. Check the Java source code to compress PDF file.
lastmod: "2026-01-03"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress PDF in Java Cloud API" h2="API for working with optimizing PDF documents using Cloud Java SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to compress PDF via Java SDK" %}}

In order to compress PDFs via Cloud Java SDK , we'll use
 [Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/)
 This Cloud SDK allows you to easily build cloud-based PDF creator, editor & compress apps in Java language for various cloud platforms. Open
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to compress PDF via Cloud Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Compress PDF using Java" offSpacer="" %}}

```java

    package com.aspose.asposecloudpdfusecases.compress;
    ...
    public class CompressPdfDocument {
        public static void Compress() {
            ...
            String PDF_OUTPUT = "output_sample_compress.pdf";
            ...
            try{
                ...
                AsposeResponse response = pdfApi.postOptimizeDocument(PDF_DOCUMENT, optimizeOptions, null, REMOTE_FOLDER);
                if (response.getCode() != 200)
                    System.err.println("Error: unexpected error when compressing document! '" + response.getStatus() + "'");
                else {
                    // download changed PDF file from remote folder...
                        File f = pdfApi.downloadFile(Path.of(REMOTE_FOLDER , PDF_DOCUMENT).toString(), null, null);
                        java.nio.file.Files.copy(Path.of(f.getPath()), Path.of(LOCAL_FOLDER, PDF_OUTPUT), StandardCopyOption.REPLACE_EXISTING);
                        System.out.println(String.format("File '%s' successfully dowloaded!", Path.of(LOCAL_FOLDER, PDF_OUTPUT).toString()));                
                        System.out.println("Successfully compressed documents ! '" + PDF_OUTPUT + "'");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
...
{{% blocks/products/pf/agp/content h2="With our Java library you can" %}}

Compress PDF documents with [Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/).
