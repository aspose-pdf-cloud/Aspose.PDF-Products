---
title: Move Page to New Position via Cloud Java SDK
url: java/pages/move/
description: Move Page from PDFs to new position using Aspose.PDF Cloud SDK for Java.
lastmod: "2025-11-07"
---
...
{{% blocks/products/pf/agp/content h2="How to move page from PDF documents to new position using Cloud Java SDK " %}}

 In order to move page from PDF documents to new position via Cloud Java SDK, we'll use
