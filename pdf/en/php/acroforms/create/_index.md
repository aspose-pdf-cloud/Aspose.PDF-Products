---
title: Creating an AcroForm via Cloud PHP SDK
url: php/acroforms/add/
description: Add form fields to PDFs in PHP apps using Aspose.PDF Cloud SDK. Simplify interactive form creation.
lastmod: "2025-10-15"
---
...
{{% blocks/products/pf/agp/content h2="How to create an AcroForm via PHP SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to create AcroForms via PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows creating an AcroForms in PDF documents using PHP" offSpacer="" %}}
...
Add the AcroForms into PDF documents with [Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/).
