---
title: Add Image stamp to pages via Cloud .NET SDK
url: net/pages/add/image-stamp
description: Add Image stamp to pages of PDFs using Aspose.PDF Cloud SDK for .NET.
lastmod: "2025-08-05"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Image stamp on pages of PDF via .NET SDK" h2="API for adding image stamp to pages of the PDF documents with .NET." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to append image stamp to pages of the PDF documents using Cloud .NET SDK " %}}

 In order to add image stamp to pages of the PDF documents via Cloud .NET SDK , we'll use
