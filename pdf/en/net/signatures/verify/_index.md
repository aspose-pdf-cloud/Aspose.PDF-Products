---
title: Verify Signatures via Cloud .NET SDK 
...
{{% blocks/products/pf/agp/content h2="How to verify signatures in PDF documents using Cloud .NET SDK " %}}

 For verify signatures in PDF documents via Cloud .NET SDK , we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to verify signatures using .NET SDK" %}}
...
1. Verify signatures in PDF documents via cloud starage using GetVerifySignatureAsync function
1. Checks the response and logs the result
1. If the operation was successful, print validation status of signature

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="This sample code shows verify signatures in PDF document" offSpacer="" %}}
...
By verify of signatures, one allows to systematically check documents for validity and relevance and document integrity. Tasks such as document signature verification or signatures analysis provide automation, saving time and reducing manual effort.
Verify Signatures in PDF documents with [Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/).
