...
{{< blocks/products/pf/upper-banner h1="Convert PDF to SVG in .NET SDK" h2="Convert PDF documents to SVG format with Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to SVG via .NET SDK" %}}
...
```cs
    ...
    public static void ConvertPdfToSvg()
    {
        ...
        using Stream response = pdfApi.GetPdfInStorageToSvg(storageImageFileName);
