...
{{< blocks/products/pf/upper-banner h1="Convert PDF to GIF in .NET SDK" h2="Convert PDF documents to GIF format with Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
```cs
    ...
    public static void ConvertPdfToGif()
    {
        ...
        using Stream response = pdfApi.GetPageConvertToGif(storageImageFileName, 1);
