...
{{< blocks/products/pf/upper-banner h1="Convert PDF to PNG in .NET SDK" h2="Convert PDF documents to PNG format with Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
```cs
    ...
    public static void ConvertPdfToPng()
    {
        ...
        using Stream response = pdfApi.GetPageConvertToPng(storageImageFileName, 1);
