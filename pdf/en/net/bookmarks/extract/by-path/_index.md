---
title: Get Bookmarks by path via Cloud .NET SDK 
url: net/bookmarks/extract/by-path/
description: Retrieve bookmarks via bookmark path from PDF files using Aspose.PDF Cloud SDK for .NET. Enhance discoverability and indexing.
lastmod: "2026-01-29"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Get bookmarks by path from PDF in .NET SDK" h2="API for getting bookmarks by path from PDF documents using server-side .NET API." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to extract bookmarks by path from PDF documents using Cloud .NET SDK " %}}

 For getting bookmarks by path from PDF documents via Cloud .NET SDK , we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to get bookmarks by path using .NET SDK" %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows extracting bookmarks by path from PDF document using PDF Cloud .NET SDK" offSpacer="" %}}
