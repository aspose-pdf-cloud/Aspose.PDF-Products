...
```cs
	...
	public static async Task ReplaceSignatureField()
	{
	    ...
	    SignatureField field = new SignatureField(
	        PageIndex: 1,
	        Signature: signature,
	        PartialName: signatureFormField,
	        Rect: SIGNATURE_RECT);

	    var response = await pdfApi.PutSignatureFieldAsync(storageFileName, signatureFormField, field, folder: storageTempFolder);

	    if (response == null)
	        Console.WriteLine("ReplaceSignatureField(): Unexpected error!");
	    else if (response.Code < 200 || response.Code > 299)
	        Console.WriteLine("ReplaceSignatureField(): Failed to replace Pdf document signature.");
	    else {
	        ...
	        Console.WriteLine("ReplaceSignatureField(): Signature replaced successfully in the Pdf document '{0}'.", resultFileName);
	    }
	}
```
