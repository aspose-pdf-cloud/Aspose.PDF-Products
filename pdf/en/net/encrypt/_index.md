...
{{% blocks/products/pf/agp/content h2="How to encrypt PDF via Cloud .NET SDK" %}}

 For encrypt PDF documents, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to encrypt PDF via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Encrypt PDF using Cloud .NET SDK" offSpacer="" %}}
...
Encrypt PDF documents with [Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/).
