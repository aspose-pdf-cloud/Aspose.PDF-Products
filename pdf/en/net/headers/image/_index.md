---
title: Add Image to Header of PDFs via Cloud .NET SDK
...
{{% blocks/products/pf/agp/content h2="How to append an image to Header of PDF documents using Cloud .NET SDK" %}}
