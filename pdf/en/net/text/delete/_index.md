---
title: Delete Text from PDF via Cloud .NET SDK 
url: net/text/delete/
description: Delete Text from PDF documents with Aspose.PDF Cloud SDK for .NET. Automate content editing easily.
lastmod: "2026-02-02"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Delete Text from PDF via .NET SDK" h2="Remove Text from PDF Documents using server-side .NET API" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to remove text from PDF document via Cloud .NET SDK " %}}
 ...
 In order to delete text from PDF document via Cloud .NET SDK , we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to delte text from PDF document via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF Cloud developers can easily load & remove text from PDF in just a few lines of code.
...
1. Call API to Remove text from PDF.
...
```cs
    ...
    public static async Task DocumentTextDelete()
    {
        const string localImageFileName = @"C:\Samples\sample.pdf";
        const string storageFileName = "sample.pdf";
        const string localFolder = @"C:\Samples";
        const string resultFileName = "output_del_text.pdf";
        ...
        var textReplace = new TextReplace("Your-Document-Text-To-Delete", "", false, Rect: rect);
        ...
        Console.WriteLine($"DocumentTextDelete(): text was successfully deleted in PDF document {resultFileName}.");
    }
```
...
Replacenent Texts in PDF documents with [Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/).
