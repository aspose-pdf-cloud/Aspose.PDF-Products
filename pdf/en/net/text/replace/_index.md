...
<div class="container-fluid features-section bg-gray singleproduct">
    ...
    <div class="row">
        <div class="container">
            <h2 class="pr-ft">Most popular actions with replace text in PDF via .NET</h2>
            <div class="col-lg-6">
                <em class="fa fa-picture-o ico-blue fa-2x col-lg-2"></em>
                <p class="col-lg-10"><a href="https://products.aspose.cloud/pdf/net/text/replace/document/">Replace text in PDF document</a></p>
            </div>
            <div class="col-lg-6">
                <em class="fa fa-file-text ico-blue fa-2x col-lg-2"></em>
                <p class="col-lg-10"><a href="https://products.aspose.cloud/pdf/net/text/replace/page/">Replace text on page in PDF document</a></p>
            </div>
            <div class="col-lg-6">
                <em class="fa fa-file-text ico-blue fa-2x col-lg-2"></em>
                <p class="col-lg-10"><a href="https://products.aspose.cloud/pdf/net/text/replace/list/">Replace list of texts in PDF document</a></p>
            </div>
        </div>
    </div>
</div>
