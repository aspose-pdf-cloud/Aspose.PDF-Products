...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">Most popular actions with Footers in .NET</h2>
   <div class="col-lg-6">
    <em class="fa fa-picture-o ico-blue fa-2x col-lg-2"></em>
    <p class="col-lg-10"><a href="https://products.aspose.cloud/pdf/net/footers/image/">Add Image in Footer</a></p>
   </div>
   <div class="col-lg-6">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2"></em>
    <p class="col-lg-10"><a href="https://products.aspose.cloud/pdf/net/footers/text/">Add Text in Footer</a></p>
   </div>
    </div>
     </div>
      </div>

{{% blocks/products/pf/agp/content h2="How to work with Footer in PDF documents using Cloud .NET SDK" %}}

 For adding Footer to PDF documents, we'll use
