---
title: Add Text to Footer of PDFs via Cloud .NET SDK
...
{{% blocks/products/pf/agp/content h2="How to append text to Footer of PDF documents using Cloud .NET SDK" %}}
