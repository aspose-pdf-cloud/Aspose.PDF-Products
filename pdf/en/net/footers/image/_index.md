---
title: Add Image to Footer of PDFs via Cloud .NET SDK
url: net/footers/image/
description: Add image footers to PDF documents using Aspose.PDF Cloud SDK in .NET. Branding, signatures, images and more.
lastmod: "2025-08-18"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Image to Footer of PDF documents via .NET SDK" h2="API for adding Images to Footer of PDF documents with Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to append image to Footer of PDF documents using Cloud .NET SDK" %}}
