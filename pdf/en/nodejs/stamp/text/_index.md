---
title: Add Text Stamps to PDFs via Cloud Node.js SDK
url: nodejs/stamp/text/
description: Append text stamps into PDFs with Aspose.PDF Cloud SDK for Node.js.
lastmod: "2025-02-20"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Text Stamp to PDF documents via Node.js SDK" h2="API for adding PDF Document page text stamps using Aspose.PDF Cloud SDK for Node.js" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to add Text Stamp into page of PDF documents via Node.js SDK" %}}

In order to add Text Stamp to PDF, we'll use
...
1. Append new Text stamp to the document page using putPageAddStamp() function
