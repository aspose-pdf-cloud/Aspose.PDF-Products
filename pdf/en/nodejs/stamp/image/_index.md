...
description: Append image stamps to PDF documents using Node.js and Aspose.PDF Cloud SDK.
lastmod: "2025-02-20"
---
...
{{% blocks/products/pf/agp/content h2="How to add Image Stamp to PDF document pages via Node.js SDK" %}}
