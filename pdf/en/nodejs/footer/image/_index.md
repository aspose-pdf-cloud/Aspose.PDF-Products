---
title: Add Image to PDF Footer via Cloud Node.js SDK
url: nodejs/footer/image/
description: Add image footers to PDF documents using Aspose.PDF Cloud SDK in Node.js. Branding, signatures, images and more.
lastmod: "2025-02-20"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Image to PDF document footer via Node.js SDK" h2="API for adding an image to the footer of a PDF document using Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to add Image Footer via Node.js SDK" %}}

In order to add Image Footer to PDF, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to add Footer via Cloud Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud developers can easily add Image in Footer of PDF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows adding Footer using Node.js" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Work with the Footer via Node.js SDK" %}}
...
Add the Footer into PDF documents with [Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/).
