...
url: /net/splitter/pdf/
description: This topic explain you how to split all or specific pages of a PDF file and save each page as a new PDF or any supported format using Aspose.Pdf for Cloud API in your applications. 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Split all or specific PDF Documents using Cloud API" h2="Split Single or Selected PDF Pages in C# Cloud API without the use of any software like Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Split Multiple PDF Files Using C# Cloud API" %}}
...
{{% blocks/products/pf/agp/code-block title="Split Specific PDF File - C#" offSpacer="" %}}
...
public static void SplitSegment()
        {
            ...
            var response = pdfApi.PostSplitDocument(storageFileName,"jpeg", 1, 3);
        }
```
