...
{{% blocks/products/pf/agp/content h2="How to Convert PNG to PDF Using SDK for .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PNG to PDF via Cloud .NET SDK" %}}
...
{{< blocks/products/pf/json-ld-howto howToName="How to convert PNG to PDF using Cloud .NET SDK" howToDesc="Sample code for PNG to PDF C# conversion."
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PNG to PDF Cloud .NET SDK Conversion" offSpacer="" %}}

```cs
public static void ConvertPNGtoPDF()
{
    var localImageFileName = @"C:\Samples\Conversion\sample.png";
    var storageImageFileName = "sample.png";
    ...
    var response = pdfApi.PutImageInStorageToPdf("sample-png-to-pdf.pdf", imageTemplatesRequest);
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PNG to PDF" sectionDescription="Check our live demos for [PNG to PDF conversion](https://products.aspose.app/pdf/conversion/png-to-pdf) with following benefits." >}}
