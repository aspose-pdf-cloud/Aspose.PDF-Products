...
{{< blocks/products/pf/upper-banner h1="Convert PDF to TEX via Cloud .NET SDK" h2="Export PDF documents to multiple formats including TEX with Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to TEX Using SDK for .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to TEX  via Cloud .NET SDK" %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to TEX Cloud .NET SDK Conversion" offSpacer="" %}}
...
public static void ConvertPDFtoLaTex()
{
    ...
    response.CopyTo(System.IO.File.OpenWrite("sample-tex.zip"));
