---
title: Chuyển đổi XPS sang PDF qua Cloud .NET SDK
url: net/conversion/xps-to-pdf/
description: Chuyển đổi tài liệu XPS thành PDF sử dụng Aspose.PDF Cloud SDK cho .NET. Đơn giản hóa khả năng tương thích đa nền tảng.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi XPS sang PDF trong .NET SDK" h2="Xuất tài liệu XPS sang nhiều định dạng bao gồm PDF với Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chuyển đổi XPS sang PDF Sử dụng SDK cho .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Chuyển đổi XPS sang PDF - Cloud .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển Aspose.PDF Cloud có thể dễ dàng tải và chuyển đổi các tệp XPS sang PDF chỉ trong vài dòng mã.
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này cho thấy Chuyển đổi XPS sang PDF Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-docx/" name="PDF TO DOCX" description="Tài liệu từ Office 2007+" >}}
