---
title: Chuyển đổi PDF sang TXT qua Cloud .NET SDK
url: net/conversion/pdf-to-txt/
description: Xuất văn bản từ PDF sang định dạng TXT bằng cách sử dụng Aspose.PDF Cloud SDK cho .NET. Đầu ra nhẹ và có thể tìm kiếm.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang TXT trong .NET SDK" h2="Chuyển đổi tài liệu PDF sang định dạng TXT với Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi PDF sang TXT bằng SDK cho .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để chuyển đổi PDF sang TXT qua .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển Aspose.PDF Cloud có thể dễ dàng tải và chuyển đổi tệp PDF sang TXT chỉ trong vài dòng mã.
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị chuyển đổi PDF sang TXT bằng Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-svg/" name="PDF SANG SVG" description="Đồ họa Vector Có thể Phóng to" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-tiff/" name="PDF SANG TIFF" description="Định dạng Hình ảnh Đánh dấu" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/svg-to-pdf/" name="SVG SANG PDF" description="Đồ họa Vector Có thể Phóng to" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/tiff-to-pdf/" name="TIFF SANG PDF" description="Định dạng Hình ảnh Đánh dấu" >}}
