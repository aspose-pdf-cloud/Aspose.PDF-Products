---
title: Chuyển đổi PDF sang EPUB qua Cloud .NET SDK
url: net/conversion/pdf-to-epub/
description: Chuyển đổi tài liệu PDF thành sách điện tử EPUB với Aspose.PDF Cloud SDK cho .NET. Tái bố trí nội dung để đọc trên di động.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang EPUB trong .NET SDK" h2="Chuyển đổi tài liệu PDF sang định dạng EPUB với Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chuyển đổi PDF sang EPUB Sử dụng SDK cho .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước Chuyển đổi PDF sang EPUB qua .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển Aspose.PDF Cloud có thể dễ dàng tải & chuyển đổi các tập tin PDF sang EPUB chỉ trong vài dòng mã.
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi PDF sang EPUB với Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-html/" name="PDF SANG HTML" description="Ngôn ngữ Đánh dấu Văn bản Siêu văn bản" >}}
