---
title: Trích xuất & Thêm tệp đính kèm trong tài liệu PDF qua Aspose.Pdf Cloud Python SDK
url: python/attachments/
description: Quản lý các tệp đính kèm PDF trong Python bằng cách sử dụng Aspose.PDF Cloud SDK. Nhúng hoặc truy cập tệp chỉ trong vài dòng mã.
lastmod: 2024-10-31
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tệp đính kèm trong PDF trong Python SDK" h2="API để làm việc với tệp đính kèm trong tài liệu PDF với Aspose.PDF Cloud Python SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để lấy tệp đính kèm qua Python SDK" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển Aspose.PDF Cloud Python có thể dễ dàng trích xuất và thêm tệp đính kèm trong tài liệu PDF. Các nhà phát triển chỉ cần vài dòng mã.
...
1. Phản hồi từ hàm Cloud API sẽ chứa danh sách tệp đính kèm

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Mã mẫu này cho thấy cách trích xuất tệp đính kèm của tài liệu PDF sử dụng PDF Cloud Python SDK" offSpacer="" %}}
