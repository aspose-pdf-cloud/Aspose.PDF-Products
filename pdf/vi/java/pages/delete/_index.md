---
title: Xóa Trang bằng Cloud Java SDK
url: java/pages/delete/
description: Xóa các trang khỏi tệp PDF bằng Aspose.PDF Cloud SDK cho Java.
lastmod: 2025-11-07
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Xóa các trang khỏi PDF bằng Java SDK" h2="API để xóa các trang trong tài liệu PDF bằng Java" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách xóa các trang khỏi tài liệu PDF bằng Cloud Java SDK " %}}

Để xóa các trang khỏi tài liệu PDF thông qua Cloud Java SDK, chúng tôi sẽ sử dụng
...
Để triển khai nó vào kho Maven từ xa thay thế, hãy cấu hình cài đặt của kho và thực thi:
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước xóa trang bằng Java SDK" %}}
...
1. Xóa trang khỏi PDF trong bộ nhớ đám mây.
1. Kiểm tra phản hồi và ghi lại kết quả.
1. Tải về tệp đã cập nhật để sử dụng cục bộ.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị cách xóa các trang khỏi tài liệu PDF" offSpacer="" %}}
...
Xóa các trang trong tài liệu PDF với [Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/).
...
+ Bạn có thể dùng thử [ứng dụng miễn phí](https://products.aspose.app/pdf/) của chúng tôi để kiểm tra chức năng SDK.
