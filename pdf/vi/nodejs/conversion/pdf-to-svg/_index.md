---
title: Chuyển đổi PDF sang SVG qua Cloud Node.js SDK
url: nodejs/conversion/pdf-to-svg/
description: Xuất nội dung PDF thành hình ảnh vector SVG sử dụng Node.js và Aspose.PDF Cloud SDK.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang SVG trong Node.js SDK" h2="Xuất tài liệu PDF sang nhiều định dạng bao gồm SVG với Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chuyển đổi PDF sang SVG Sử dụng Node.js SDK" %}}

Để chuyển đổi PDF sang SVG, chúng tôi sẽ sử dụng
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Cloud SDK này hỗ trợ các lập trình viên Node.js phát triển ứng dụng tạo, chú thích, chỉnh sửa và chuyển đổi PDF dựa trên đám mây sử dụng ngôn ngữ lập trình Node.js thông qua Aspose.PDF REST API. Mở
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước Chuyển đổi PDF sang SVG qua Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển Aspose.PDF Cloud Node.js có thể dễ dàng tải & chuyển đổi tệp PDF sang SVG chỉ trong vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải Khoá Ứng dụng và Bí mật từ tệp JSON hoặc thiết lập thông tin xác thực theo cách khác
1. Tạo đối tượng để kết nối với Cloud API
1. Tải lên tệp tài liệu của bạn
1. Thực hiện chuyển đổi sử dụng getPdfInStorageToSvg
1. Tải xuống kết quả nếu cần thiết

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi PDF sang SVG Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/jpeg-to-pdf/" name="JPEG SANG PDF" description="Nhóm Chuyên gia Ảnh" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-jpeg/" name="PDF SANG JPEG" description="Nhóm Chuyên gia Nhiếp ảnh Joint" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xps/" name="PDF SANG XPS" description="Đặc điểm Kỹ thuật Giấy XML" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/xps-to-pdf/" name="XPS SANG PDF" description="Đặc điểm Kỹ thuật Giấy XML" >}}
