---
title: Chuyển đổi PDF sang XPS thông qua Cloud Node.js SDK
url: nodejs/conversion/pdf-to-xps/
description: Chuyển đổi PDF sang định dạng XPS sử dụng Aspose.PDF Cloud SDK cho Node.js. Duy trì tính toàn vẹn bố cục.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang XPS trong Node.js SDK" h2="Xuất tài liệu PDF sang nhiều định dạng bao gồm XPS với Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi PDF sang XPS sử dụng Node.js SDK" %}}

Để chuyển đổi PDF sang XPS, chúng tôi sẽ sử dụng
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Cloud SDK này hỗ trợ lập trình viên Node.js phát triển ứng dụng tạo, chú thích, chỉnh sửa và chuyển đổi PDF trên nền tảng đám mây sử dụng ngôn ngữ lập trình Node.js thông qua Aspose.PDF REST API. Mở
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi PDF sang XPS qua Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển Aspose.PDF Cloud Node.js có thể dễ dàng tải và chuyển đổi tệp PDF sang XPS chỉ với vài dòng mã.
...
1. Thực hiện chuyển đổi sử dụng getPdfInStorageToXps
1. Tải xuống kết quả nếu cần thiết

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Mẫu mã này hiển thị chuyển đổi PDF sang XPS Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/jpeg-to-pdf/" name="JPEG SANG PDF" description="Nhóm Chuyên gia Nhiếp ảnh Liên hợp" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF SANG XLSX" description="Tệp Bảng tính Mở Định dạng XML của Microsoft Excel" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xps/" name="PDF SANG XPS" description="Quy định Giấy XML" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/xps-to-pdf/" name="XPS SANG PDF" description="Quy định Giấy XML" >}}
