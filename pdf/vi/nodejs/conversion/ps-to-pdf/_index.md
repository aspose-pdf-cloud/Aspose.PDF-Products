---
title: Chuyển đổi PS sang PDF qua Cloud Node.js SDK
weight: 2710
url: nodejs/conversion/ps-to-pdf/
description: Chuyển đổi tệp PostScript (PS) thành PDF bằng Aspose.PDF Cloud SDK cho Node.js.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PS sang PDF trong Node.js SDK" h2="Xuất tài liệu PS sang nhiều định dạng khác bao gồm PDF với Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chuyển đổi PS sang PDF Sử dụng Node.js SDK" %}}

Để chuyển đổi PS sang PDF, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước Chuyển đổi PS sang PDF qua Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển Aspose.PDF Cloud Node.js có thể dễ dàng tải & chuyển đổi tệp PS sang PDF chỉ trong vài dòng mã.
...
1. Thực hiện chuyển đổi sử dụng putPsInStorageToPdf
1. Tải xuống kết quả nếu cần

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Mã mẫu này cho thấy Chuyển đổi PS sang PDF bằng Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Các Chuyển đổi Hỗ trợ Khác" subTitle="Bạn cũng có thể chuyển đổi MD sang nhiều định dạng tệp khác bao gồm một số định dạng được liệt kê dưới đây." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-jpeg/" name="PDF SANG JPEG" description="Nhóm chuyên gia về nhiếp ảnh" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-svg/" name="PDF SANG SVG" description="Đồ họa véc tơ có thể mở rộng" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-tiff/" name="PDF SANG TIFF" description="Định dạng hình ảnh có thẻ" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF SANG XLSX" description="Tệp định dạng bảng tính mở XML Microsoft Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/svg-to-pdf/" name="SVG SANG PDF" description="Đồ họa véc tơ có thể mở rộng" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/tiff-to-pdf/" name="TIFF SANG PDF" description="Định dạng hình ảnh có thẻ" >}}
