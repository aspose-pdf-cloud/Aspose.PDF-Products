---
title: Chuyển đổi PDF sang DOC qua Cloud Node.js SDK
url: nodejs/conversion/pdf-to-word/
description: Chuyển đổi tệp PDF thành tài liệu Word có thể chỉnh sửa bằng cách sử dụng Aspose.PDF Cloud SDK cho Node.js.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang DOC trong Node.js SDK" h2="Xuất tài liệu PDF sang nhiều định dạng bao gồm DOC với Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi PDF sang DOC bằng Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi PDF sang DOC qua Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển Aspose.PDF Cloud Node.js có thể dễ dàng tải và chuyển đổi các tệp PDF sang DOC chỉ trong vài dòng mã.
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị chuyển đổi Cloud Node.js SDK từ PDF sang DOC" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/epub-to-pdf/" name="EPUB SANG PDF" description="Định dạng Tập tin Siêu tệp" >}}
