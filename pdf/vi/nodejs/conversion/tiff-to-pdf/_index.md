---
title: Chuyển đổi TIFF sang PDF qua Cloud Node.js SDK
url: nodejs/conversion/tiff-to-pdf/
description: Chuyển đổi tệp hình ảnh TIFF sang PDF với Node.js sử dụng Aspose.PDF Cloud SDK.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi TIFF sang PDF trong Node.js SDK" h2="Xuất tài liệu TIFF sang nhiều định dạng khác bao gồm PDF với Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi TIFF sang PDF sử dụng Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi TIFF sang PDF qua Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển Node.js sử dụng Aspose.PDF Cloud có thể dễ dàng tải & chuyển đổi các tệp TIFF sang PDF chỉ với vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải khóa bí mật và khóa ứng dụng của bạn từ tệp JSON hoặc thiết lập thông tin xác thực theo cách khác
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị chuyển đổi TIFF sang PDF Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Các chuyển đổi được hỗ trợ khác" subTitle="Bạn cũng có thể chuyển đổi MD sang nhiều định dạng tệp khác bao gồm một số định dạng được liệt kê dưới đây." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/epub-to-pdf/" name="EPUB SANG PDF" description="Định dạng Metafile được nâng cao" >}}
