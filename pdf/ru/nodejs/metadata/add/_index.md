---
title: Добавить метаданные через Cloud Node.js SDK
url: nodejs/metadata/add/
description: Добавьте метаданные в PDF с помощью Node.js, используя Aspose.PDF Cloud SDK. Улучшите индексирование документов и их доступность для поиска.
lastmod: 2024-11-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Добавить метаданные в PDF в Node.js SDK" h2="Добавление метаданных в PDF-документ с использованием Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Как создать метаданные через Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для создания метаданных через Cloud Node.js" %}}
...
1. Загружает PDF-файл в облачное хранилище Aspose.PDF.
1. Создает объект свойства метаданных с ключом, значением и URI пространства имен.
1. Добавляет свойство метаданных в PDF-файл, используя Aspose.PDF Cloud API.
1. Записывает статус операции в консоль.

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Создание XMP-свойств метаданных в PDF с использованием Node.js" offSpacer="" %}}
...
Метаданные также улучшают поиск файлов, позволяя искать по ключевым словам и атрибутам. Это особенно ценно в системах, где необходима быстрая выборка документов.
Добавьте метаданные в PDF-документы с [Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/).
...
+ Вы можете попробовать наше [бесплатное приложение](https://products.aspose.app/pdf/metadata) для добавления метаданных в PDF-файлы онлайн и тестирования функциональности.
