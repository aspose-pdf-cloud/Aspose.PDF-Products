---
title: Преобразование PDF в DOCX через Cloud Node.js SDK
url: nodejs/conversion/pdf-to-docx/
description: Преобразуйте PDF в DOCX с помощью Aspose.PDF Cloud SDK для Node.js. Редактируйте ваши PDF в Microsoft Word.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование PDF в DOCX в Node.js SDK" h2="Экспортируйте PDF-документы в различные форматы, включая DOCX, с помощью Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать PDF в DOCX используя Node.js SDK" %}}

Для преобразования PDF в DOCX мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по преобразованию PDF в DOCX с помощью Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Разработчики Aspose.PDF Cloud Node.js могут легко загрузить и преобразовать PDF-файлы в DOCX всего за несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите ваш секретный ключ приложения и ключ из файла JSON или установите учетные данные другим способом
1. Создайте объект для подключения к Cloud API
1. Загрузите ваш файл документа
1. Выполните преобразование с помощью getPdfInStorageToDoc
1. Загрузите результат, если это необходимо

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Этот пример кода демонстрирует преобразование PDF в DOCX Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-jpeg/" name="PDF TO JPEG" description="Группа экспертов по фотографии" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF TO XLSX" description="Формат открытого XML-файла электронной таблицы Microsoft Excel" >}}
