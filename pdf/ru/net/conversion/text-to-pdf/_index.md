---
title: Конвертировать текст в PDF через Cloud .NET SDK
url: net/conversion/text-to-pdf/
description: Преобразуйте текстовые файлы в форматированные PDF с помощью Aspose.PDF Cloud SDK для .NET.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Конвертировать текст в PDF в .NET SDK" h2="Экспортируйте текстовые документы в различные форматы, включая PDF, с помощью Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Как конвертировать текст в PDF с использованием SDK для .NET" %}}

Для того чтобы конвертировать текст в PDF, мы используем
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по конвертации текста в PDF через .NET SDK" %}}
...
{{% blocks/products/pf/agp/code-block title="Этот пример кода показывает конвертацию текста в PDF с помощью Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/emf-to-pdf/" name="EMF В PDF" description="Формат метафайлов EMF" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/gif-to-pdf/" name="GIF В PDF" description="Формат графических файлов GIF" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-emf/" name="PDF В EMF" description="Формат метафайлов EMF" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-gif/" name="PDF В GIF" description="Формат графических файлов GIF" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-pdfa/" name="PDF TO PDF/A" description="Портативный формат документов/А" >}}
