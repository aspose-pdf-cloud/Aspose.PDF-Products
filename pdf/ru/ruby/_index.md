...
<p class="col-lg-10">Чтение или удаление таблицы документа по идентификатору</p>
</div>
<div class="col-lg-4">
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.PDF Cloud Ruby SDK?" tabId="success-stories" >}}
