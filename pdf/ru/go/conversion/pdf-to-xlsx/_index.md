---
title: Преобразование PDF в XLSX через Cloud Go SDK
url: /go/conversion/pdf-to-xlsx/
description: Экспорт таблиц и содержимого PDF в XLSX с использованием Aspose.PDF Cloud SDK для Go.
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование PDF в XLSX в Go SDK" h2="Экспорт документов PDF в различные форматы, включая XLSX, с помощью Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать PDF в XLSX с помощью Go SDK" %}}

Для преобразования PDF в XLSX мы используем
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для преобразования PDF в XLSX через Go" %}}

{{% blocks/products/pf/agp/text %}}

Разработчики Aspose.PDF Cloud Go могут легко загружать и конвертировать PDF в XLSX всего за несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузка PDF файла в облачное хранилище Aspose.
1. Конвертация PDF в формат XLSX.
1. Сохранение выходного XLSX в облачном хранилище.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Этот пример кода показывает преобразование PDF в XLSX с помощью Cloud Go SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Другие поддерживаемые преобразования" subTitle="Вы также можете конвертировать многие другие форматы файлов, включая несколько указанных ниже." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/pcl-to-pdf/" name="PCL В PDF" description="Язык принтерных команд" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/pdf-to-pdfa/" name="PDF В PDF/A" description="Формат переносимого документа" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/pdf-to-xlsx/" name="PDF TO XLSX" description="Файл таблицы Microsoft Excel Open XML Format" >}}
