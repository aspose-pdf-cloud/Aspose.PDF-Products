---
title: Удаление аннотаций страницы через Cloud Go SDK
url: /go/annotations/page/delete
description: Удаление аннотаций страницы из PDF с использованием Aspose.PDF Cloud SDK для Go.
lastmod: 2025-07-20
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Удаление аннотаций страницы из PDF через Go SDK" h2="API для удаления аннотаций в документах PDF с помощью Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Как удалить аннотации страницы из PDF документов с помощью Cloud Go SDK" %}}

Для удаления аннотаций страницы из PDF документов мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для удаления аннотаций с использованием Go" %}}
...
1. Удаление аннотаций на указанной странице с использованием DeletePageAnnotations().
1. Загрузка измененного документа.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Этот пример кода показывает удаление аннотаций страницы из PDF документа с использованием PDF Cloud Go SDK" offSpacer="" %}}
...
+ Вы можете попробовать наше [бесплатное приложение](https://products.aspose.app/pdf/), чтобы удалять аннотации из файлов PDF онлайн и тестировать функциональность.
