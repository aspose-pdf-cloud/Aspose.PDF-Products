---
title: Извлечение страниц из PDF через облачный SDK для PHP
url: php/pages/extract/
description: Извлечение определенных страниц из PDF с использованием PHP и Aspose.PDF Cloud SDK. Легко разделяйте или анализируйте содержимое.
lastmod: 2025-03-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Извлечение страниц из PDF в PHP SDK" h2="Извлечение страниц из PDF документов с использованием облачного SDK для PHP." logoImageSrc="/sdk/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="for PHP" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для получения страниц из PDF через облачное PHP" %}}
...
1. Получите информацию обо всех страницах в документе
1. Извлеките информацию о конкретной странице

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Извлечение страниц из PDF с использованием PHP" offSpacer="" %}}
