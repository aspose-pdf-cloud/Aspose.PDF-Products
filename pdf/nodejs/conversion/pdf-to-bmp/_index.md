---
title: Convert PDF to BMP via Cloud Node.js SDK
url: /nodejs/conversion/pdf-to-bmp/
description: Sample code for PDF to BMP Cloud Node.js SDK conversion. Use API example code for batch PDF files to BMP conversion with Aspose.PDF Cloud.
lastmod: "2022-03-17"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to BMP in Node.js SDK" h2="Export PDF documents to multiple formats including BMP with Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to BMP Using Node.js SDK" %}}

 To convert PDF to BMP, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to BMP via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF Cloud Node.js developers can easily load & convert PDF files to BMP in just a few lines of code.
...
1. Perform the conversion using getPageConvertToBmp
