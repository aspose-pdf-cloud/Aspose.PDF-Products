...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to GIF Using Node.js SDK" %}}

 To convert PDF to GIF, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to GIF via Node.js SDK" %}}
...
1. Perform the conversion using getPageConvertToGif
