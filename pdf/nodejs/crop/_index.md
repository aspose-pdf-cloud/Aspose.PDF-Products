---
title: Crop PDF via Cloud Node.js SDK 
url: /nodejs/crop/
description: Aspose.PDF Cloud allows you to crop PDF Document. Check the Node.js source code to crop PDF file.
lastmod: "2025-07-28"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Crop PDF in Node.js Cloud API" h2="API for working with cropping PDF documents using Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Crop PDF via Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to crop PDF via Cloud Node.js" %}}
...
1. Get page size info
1. Extract page as image (full original page)
1. Create a new PDF with the specified cropped size
1. Insert cropped image portion into new PDF
1. Download resulting file if success

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Crop PDF using Node.js" offSpacer="" %}}
...
Crop PDF documents with [Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/).
