...
{{< blocks/products/pf/upper-banner h1="Add Text in Footer of PDF via Node.js Cloud API" h2="API for working with Text Footer in PDF documents using Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
In order to add Text Footer to PDF, we'll use
...
Aspose.PDF Cloud developers can easily add Text in Footer of PDF in just a few lines of code.
