...
description: Aspose.PDF Cloud allows you to add an Images to a PDF Document. Check the Node.js source code to add an Images into PDF file.
lastmod: "2024-10-19"
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Images to PDF document via Node.js Cloud API" h2="API for working with Images in PDF documents using Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="How to add Images to PDF via Node.js SDK" %}}

To add images into PDF, we'll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to add Images to PDF using Node.js" %}}
...
{{% blocks/products/pf/agp/code-block title="Add Images to PDF using Node.js" offSpacer="" %}}
...
Add the Images into PDF documents with [Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/).
...
{{< blocks/products/pf/agp/demobox sectionTitle="Change Image dimensions online App" sectionDescription="Crop Images in PDF by visiting our [Live Demos website](https://products.aspose.app/pdf/crop). The live demo has the following benefits" >}}
