---
title: إضافة ملفاتացված إلى مستندات PDF من خلال Aspose.Pdf Cloud .NET SDK
url: net/attachments/add/
description: إضافة ملفات{ZI} إلى ملفات PDF مع Aspose.PDF Cloud SDK for .NET. تضمين مستندات، صور، Invasion إلى PDFs.
lastmod: 2024-10-29
---
