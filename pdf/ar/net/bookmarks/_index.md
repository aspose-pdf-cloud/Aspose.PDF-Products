---
title: العمل مع الإشارات المرجعية في PDF عبر Cloud .NET SDK
url: net/bookmarks/
description: العمل مع الإشارات المرجعية في ملفات PDF باستخدام Aspose.PDF Cloud SDK لـ .NET. تعزيز إمكانية الاكتشاف والفهرسة.
lastmod: 2025-08-12
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="العمل مع الإشارات المرجعية في PDF في .NET SDK" h2="تلاعب بالإشارات المرجعية في مستند PDF باستخدام API خادم .NET." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
<div class="row">
<div class="container">
<h2 class="pr-ft">أشهر الإجراءات مع الصفحات في .NET</h2>
<div class="col-lg-4">
<em class="fa fa-picture-o ico-blue fa-2x col-lg-2"></em>
<p class="col-lg-10"><a href="https://products.aspose.cloud/pdf/net/bookmarks/add/">إضافة إشارات مرجعية إلى PDF</a></p>
</div>
<div class="col-lg-4">
...
{{% blocks/products/pf/agp/content h2="كيفية العمل مع الإشارات المرجعية عبر Cloud .NET SDK " %}}

من أجل العمل مع الإشارات المرجعية في PDF عبر Cloud .NET SDK، سنستخدم
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
هذا الـ SDK السحابي يسمح لك بسهولة ببناء تطبيقات إنشاء، تحرير وتحويل PDF تعتمد على السحابة في C#، ASP.NET، أو لغات .NET أخرى لمختلف منصات السحابة. افتح
[NuGet](https://www.nuget.org/packages/Aspose.Pdf-Cloud)
مدير الحزم، وابحث عن
Aspose.PDF Cloud وقم بالتثبيت. يمكنك أيضًا استخدام الأمر التالي من وحدة تحكم مدير الحزم.
...
1. قم بتعيين الخاصية المطلوبة باستخدام PostBookmarkAsync
