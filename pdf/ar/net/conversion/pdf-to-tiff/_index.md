---
title: تحويل ملفات PDF إلى صور TIFF عبر Cloud .NET SDK
url: net/conversion/pdf-to-tiff/
description: حوّل ملفات PDF إلى تنسيق TIFF باستخدام Aspose.PDF Cloud SDK لـ .NET. مثالي للإرسال بالفاكس والأرشفة.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PDF إلى TIFF في .NET SDK" h2="حوّل مستندات PDF إلى تنسيق TIFF مع Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PDF إلى TIFF باستخدام SDK لـ .NET" %}}

من أجل تحويل PDF إلى TIFF، سنستخدم
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
يتيح لك هذا Cloud SDK بسهولة بناء تطبيقات إنشاء وتحرير وتحويل PDF قائمة على السحابة بلغة C# أو ASP.NET أو لغات .NET الأخرى لمختلف منصات السحابة. افتح
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل PDF إلى TIFF عبر .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

يمكن لمطوري Aspose.PDF Cloud تحميل وتحويل ملفات PDF إلى TIFF بسهولة في بضع سطور من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="هذا الكود النموذجي يوضح تحويل PDF إلى TIFF باستخدام Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/bmp-to-pdf/" name="BMP TO PDF" description="صورة بتنسيق Bitmap" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/emf-to-pdf/" name="EMF TO PDF" description="تنسيق ملف متجه محسن" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-bmp/" name="PDF TO BMP" description="صورة بتنسيق Bitmap" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-emf/" name="PDF TO EMF" description="تنسيق ملف متجه محسن" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-svg/" name="PDF إلى SVG" description="رسومات متجهية قابلة للتطوير" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/svg-to-pdf/" name="SVG إلى PDF" description="رسومات متجهية قابلة للتطوير" >}}
