---
title: تحويل PDF إلى DOCX مايكروسوفت وورد عبر Cloud .NET SDK
url: net/conversion/pdf-to-docx/
description: قم بتحويل ملفات PDF إلى مستندات DOCX قابلة للتحرير باستخدام Aspose.PDF Cloud SDK لـ .NET. حافظ على التنسيق وهيكل النص.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PDF إلى DOCX في .NET SDK" h2="تحويل ملفات PDF إلى تنسيق DOCX باستخدام Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
يتيح لك هذا SDK السحابي بناء تطبيقات إنشاء وتحرير وتحويل PDF قائمة على السحابة بسهولة باستخدام C#، ASP.NET، أو لغات .NET أخرى لمنصات السحابة المختلفة. افتح
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل PDF إلى DOCX عبر .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

يمكن لمطوري Aspose.PDF Cloud تحميل وتحويل ملفات PDF إلى DOCX بسهولة في بضع سطور من الكود.

{{% /blocks/products/pf/agp/text %}}

1. أنشئ كائن تكوين جديد مع مفتاح وتطبيق السر الخاص بك
1. أنشئ كائنًا للاتصال بواجهة برمجة التطبيقات السحابية
1. قم برفع ملف مستندك
1. قم بإجراء التحويل
1. قم بتنزيل النتيجة
...
{{% blocks/products/pf/agp/code-block title="يوضح كود العينة هذا تحويل PDF إلى DOCX Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/html-to-pdf/" name="HTML-TO-PDF" description="لغة الترميز التشعبية" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-docx/" name="PDF TO DOCX" description="مستند أوفيس 2007+" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-pdfa/" name="PDF TO PDF/A" description="تنسيق المستند المنقول/A" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-svg/" name="PDF TO SVG" description="رسومات متجهة قابلة للتوسع" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/svg-to-pdf/" name="SVG TO PDF" description="رسومات متجهة قابلة للتوسع" >}}
