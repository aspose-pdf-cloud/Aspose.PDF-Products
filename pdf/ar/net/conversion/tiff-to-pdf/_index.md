---
title: تحويل TIFF إلى PDF عبر Cloud .NET SDK
url: net/conversion/tiff-to-pdf/
description: حوّل ملفات صور TIFF إلى PDF باستخدام Aspose.PDF Cloud SDK لـ .NET. موثوق لأرشفة المستندات الممسوحة ضوئيًا.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل TIFF إلى PDF في .NET SDK" h2="صدّر مستندات TIFF إلى تنسيقات متعددة بما في ذلك PDF باستخدام Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TIFF إلى PDF باستخدام SDK لـ .NET" %}}

لتحويل TIFF إلى PDF، سنستخدم
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
هذا SDK السحابي يسمح لك ببناء تطبيقات إنشاء وتحرير وتحويل PDF المستندة إلى السحابة بسهولة في C#، ASP.NET، أو لغات .NET الأخرى لمنصات السحابة المختلفة. افتح
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TIFF إلى PDF عبر .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

يمكن لمطوري Aspose.PDF Cloud تحميل وتحويل ملفات TIFF إلى PDF بسهولة في بضع سطور من الكود.

{{% /blocks/products/pf/agp/text %}}

1. أنشئ كائن تكوين جديد باستخدام مفتاح التطبيق والسر الخاص بك
...
{{% blocks/products/pf/agp/code-block title="يوضح هذا الكود النموذجي تحويل TIFF إلى PDF باستخدام Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/emf-to-pdf/" name="EMF TO PDF" description="تنسيق Metafile المحسن" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/gif-to-pdf/" name="GIF TO PDF" description="تنسيق التبادل الرسومي" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-emf/" name="PDF TO EMF" description="تنسيق Metafile المحسن" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-html/" name="PDF إلى HTML" description="لغة برمجة النصوص التشعبية" >}}
