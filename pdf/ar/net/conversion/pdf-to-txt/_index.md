---
title: تحويل PDF إلى TXT عبر .NET SDK السحابي
url: net/conversion/pdf-to-txt/
description: تصدير النص من PDF إلى تنسيق TXT باستخدام Aspose.PDF Cloud SDK لـ .NET. إخراج خفيف الوزن وقابل للبحث.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PDF إلى TXT في .NET SDK" h2="تحويل مستندات PDF إلى تنسيق TXT باستخدام Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PDF إلى TXT باستخدام SDK لـ .NET" %}}

من أجل تحويل PDF إلى TXT، سنستخدم
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
يتيح لك هذا الـ SDK السحابي بناء تطبيقات إنشاء وتحرير وتحويل PDF معتمدة على السحابة بسهولة في C#، ASP.NET، أو لغات .NET الأخرى لمنصات سحابية مختلفة. افتح
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل PDF إلى TXT عبر .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

يمكن لمطوري Aspose.PDF Cloud تحميل وتحويل ملفات PDF إلى TXT بسهولة في بضعة أسطر من الكود.

{{% /blocks/products/pf/agp/text %}}

1. إنشاء كائن إعدادات جديد مع سر التطبيق والمفتاح الخاص بك
...
{{% blocks/products/pf/agp/code-block title="يظهر هذا الكود العينة تحويل PDF إلى TXT باستخدام Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/epub-to-pdf/" name="EPUB إلى PDF" description="تنسيق الكتب الإلكترونية" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-epub/" name="PDF إلى EPUB" description="تنسيق الكتب الإلكترونية" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-gif/" name="PDF إلى GIF" description="تنسيق الرسوم المتبادلة" >}}
