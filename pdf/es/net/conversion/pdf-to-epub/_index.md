---
title: Convertir PDF a EPUB a través de Cloud .NET SDK
url: net/conversion/pdf-to-epub/
description: Convierte documentos PDF en eBooks EPUB con Aspose.PDF Cloud SDK para .NET. Reorganiza contenido para lectura móvil.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF a EPUB en .NET SDK" h2="Convierte documentos PDF a formato EPUB con Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo Convertir PDF a EPUB Usando SDK para .NET" %}}

Para convertir PDF a EPUB, utilizaremos
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
Este Cloud SDK te permite fácilmente construir aplicaciones basadas en la nube para crear, editar y convertir PDF en C#, ASP.NET, u otros lenguajes .NET para varias plataformas en la nube. Abre
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Convertir PDF a EPUB a través de .NET SDK" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la Conversión de PDF a EPUB en Cloud .NET SDK" offSpacer="" %}}
