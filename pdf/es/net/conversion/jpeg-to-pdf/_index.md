---
title: Convertir JPEG a PDF a través de Cloud .NET SDK
url: net/conversion/jpeg-to-pdf
description: Convierta imágenes JPEG en PDF usando Aspose.PDF Cloud SDK para .NET. Combine, organice y optimice documentos de imagen.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JPEG a PDF en .NET SDK" h2="Exporte documentos JPEG a múltiples formatos, incluyendo PDF con Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo Convertir JPEG a PDF Usando SDK para .NET" %}}

Para convertir JPEG a PDF, utilizaremos
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
Este Cloud SDK le permite construir fácilmente aplicaciones en la nube de creación, edición y conversión de PDF en C#, ASP.NET u otros lenguajes .NET para varias plataformas en la nube. Abra
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Convertir JPEG a PDF vía .NET SDK" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de JPEG a PDF Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/epub-to-pdf/" name="EPUB A PDF" description="Formato de E-book" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-epub/" name="PDF A EPUB" description="Formato de E-book" >}}
