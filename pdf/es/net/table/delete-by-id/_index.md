---
title: Eliminar tabla por Id de PDF a través de Cloud .NET SDK
url: net/table/delete-by-id/
description: Eliminar tabla por Id de PDFs usando Aspose.PDF Cloud SDK para .NET. Eliminar tabla usando Id de documentos.
lastmod: 2025-08-29
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Eliminar tabla por Id de PDF en .NET SDK" h2="Eliminar tabla por Id de un documento PDF usando API de .NET del lado del servidor." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo eliminar tabla por Id de PDF a través de Cloud .NET SDK " %}}

Para eliminar tabla por Id de PDF a través de Cloud .NET SDK, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para eliminar tabla por Id de PDF a través de .NET SDK" %}}
...
1. Elimina la tabla por Id del PDF en el almacenamiento en la nube usando la función DeleteTableAsync.
1. Verifica la respuesta y registra el resultado.
1. Descarga el archivo actualizado para uso local.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la eliminación de tabla por Id de documentos PDF" offSpacer="" %}}
...
+ Puedes probar nuestra [aplicación gratuita](https://products.aspose.app/pdf/table-extraction) para extraer tabla en archivos PDF en línea y probar la funcionalidad.
