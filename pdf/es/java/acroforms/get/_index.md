---
title: Obtener campos de formulario de documento PDF mediante Cloud Java SDK
url: java/acroforms/get/
description: Recuperar datos de AcroForm de PDFs utilizando Aspose.PDF Cloud SDK para Java. Extracción fácil de campos de formulario a través de la API REST.
lastmod: 2025-11-21
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Obtener AcroForms PDF mediante SDK Java" h2="API para extraer AcroForms de documentos PDF utilizando Aspose.PDF Cloud SDK para Java." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo obtener campos AcroForm de documento PDF usando Cloud Java SDK" %}}

Para obtener un AcroForm mediante Cloud Java SDK, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para obtener AcroForms mediante SDK Java" %}}
...
1. Realice la obtención
1. Descargue el resultado

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra cómo obtener AcroForms en documentos PDF" offSpacer="" %}}
...
Agregue los AcroForms a documentos PDF con [Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/).
...
+ Puede probar nuestra [aplicación gratuita](https://products.aspose.app/pdf/xfa) para añadir los AcroForms a archivos PDF en línea y probar la funcionalidad.
