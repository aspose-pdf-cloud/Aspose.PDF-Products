---
title: Agregar anotaciones de texto resaltado a PDFs mediante SDK de Java en la nube
url: java/annotations/highlight/
description: Inserte anotaciones de texto resaltado en documentos PDF utilizando Aspose.PDF Cloud Java SDK.
lastmod: 2025-11-23
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Agregar anotaciones de texto resaltado a documentos PDF mediante SDK de Java" h2="API para agregar anotaciones de texto resaltado a documentos PDF utilizando Aspose.PDF Cloud Java SDK." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo insertar anotaciones de texto resaltado en documentos PDF utilizando Cloud Java SDK " %}}

Para agregar anotaciones a documentos PDF mediante Cloud Java SDK, utilizaremos
[Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/)
Este SDK en la nube le permite crear fácilmente aplicaciones de creación, edición y conversión de PDF basadas en la nube en lenguaje Java para diversas plataformas de nube. Abrir
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar anotaciones usando SDK de Java" %}}
...
{{% blocks/products/pf/agp/content h2="Trabaje con las anotaciones en PDF mediante SDK de Java" %}}
...
Agregue las anotaciones a los documentos PDF con [Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/).
...
+ Puedes probar nuestra [App gratuita](https://products.aspose.app/pdf/) para agregar anotaciones a archivos PDF en línea y probar la funcionalidad.
