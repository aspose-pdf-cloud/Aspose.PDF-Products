---
title: Agregar Anotaciones de Texto Resaltado a través de Cloud Go SDK
url: go/annotations/highlight/
description: Agregue Anotaciones de Texto Resaltado a PDFs usando Aspose.PDF Cloud SDK para Go.
lastmod: 2025-07-20
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Agregar Anotaciones de Texto Resaltado a PDF a través de Go SDK" h2="API para agregar anotaciones a documentos PDF con Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
Para agregar anotaciones a documentos PDF, utilizaremos
...
Los desarrolladores de Aspose.PDF Cloud Go pueden agregar fácilmente anotaciones a documentos PDF. Los desarrolladores solo necesitan unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Subir el archivo al almacenamiento en la nube.
1. Crear una anotación de resaltado con propiedades específicas (cuadro delimitador, color, texto).
1. Enviar la anotación para ser agregada a una página a través de Aspose.PDF Cloud.
1. Descargar el documento modificado si tiene éxito.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra cómo agregar anotaciones a un documento PDF usando PDF Cloud Go SDK" offSpacer="" %}}
...
+ Agregar tablas y estampillas de texto o imagen a documentos PDF.
...
+ Puedes probar nuestra [App gratuita](https://products.aspose.app/pdf/) para agregar anotaciones en archivos PDF en línea y probar la funcionalidad.
