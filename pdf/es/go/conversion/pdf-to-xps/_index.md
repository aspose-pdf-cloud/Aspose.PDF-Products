---
title: Convertir PDF a XPS a través de Cloud Go SDK
url: go/conversion/pdf-to-xps/
description: Convierta PDFs a formato XPS usando Aspose.PDF Cloud SDK para Go. Mantenga la integridad del diseño.
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF a XPS en Go SDK" h2="Exporte documentos PDF a múltiples formatos incluyendo XPS con Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo Convertir PDF a XPS Usando Go SDK" %}}

Para convertir PDF a XPS, usaremos
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
Este Cloud SDK asiste a los programadores de Go en el desarrollo de aplicaciones basadas en la nube para crear, anotar, editar y convertir PDFs usando el lenguaje de programación Go a través de Aspose.PDF REST API. Use el siguiente comando desde la Consola del Administrador de Paquetes.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Convertir PDF a XPS a través de Go" %}}

{{% blocks/products/pf/agp/text %}}

Los desarrolladores de Aspose.PDF Cloud Go pueden cargar y convertir fácilmente PDF a XPS en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargar un archivo PDF en el Almacenamiento en la Nube de Aspose.
1. Convertir el PDF al formato XPS.
1. Guardar el XPS de salida en el almacenamiento en la nube.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de PDF a XPS Cloud Go SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/epub-to-pdf/" name="EPUB A PDF" description="Formato de Metafichero Mejorado" >}}
