---
title: Convertir PDF a XLS a través de Cloud Go SDK
url: go/conversion/pdf-to-xls/
description: Exportar PDF a XLS usando Aspose.PDF Cloud SDK para Go.
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF a XLS en Go SDK" h2="Exportar documentos PDF a múltiples formatos incluyendo XLS con Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo Convertir PDF a XLS Usando Go SDK" %}}

Para convertir PDF a XLS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Convertir PDF a XLS a través de Go" %}}

{{% blocks/products/pf/agp/text %}}

Los desarrolladores de Aspose.PDF Cloud Go pueden cargar y convertir fácilmente PDF a XLS en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Subir un archivo PDF al Almacenamiento en la Nube de Aspose.
1. Convertir el PDF al formato XLS.
1. Guardar el XLS de salida en el almacenamiento en la nube.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la Conversión de PDF a XLS Cloud Go SDK" offSpacer="" %}}
