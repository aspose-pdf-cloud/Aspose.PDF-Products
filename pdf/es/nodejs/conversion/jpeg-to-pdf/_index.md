---
title: Convertir JPEG a PDF a través de Cloud Node.js SDK
url: nodejs/conversion/jpeg-a-pdf
description: Convierte imágenes JPEG en documentos PDF usando Node.js y Aspose.PDF Cloud SDK. Incrustación de imágenes de alta calidad.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JPEG a PDF en Node.js SDK" h2="Exportar documentos JPEG a múltiples formatos incluyendo PDF con Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo Convertir JPEG a PDF Usando Node.js SDK" %}}

Para convertir JPEG a PDF, usaremos
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Este SDK en la Nube ayuda a los programadores de Node.js a desarrollar aplicaciones en la nube para crear, anotar, editar y convertir PDFs utilizando el lenguaje de programación Node.js a través de Aspose.PDF REST API. Abre
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Convertir JPEG a PDF vía Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Los desarrolladores de Aspose.PDF Cloud Node.js pueden cargar y convertir fácilmente archivos JPEG a PDF en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargar tu Secreto de Aplicación y Clave desde el archivo JSON o configurar las credenciales de otra manera
1. Crear un objeto para conectar con la API en la Nube
1. Subir tu archivo de documento
1. Realizar la conversión usando putImageInStorageToPdf
1. Descargar el resultado si es necesario

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la Conversión de JPEG a PDF con Cloud Node.js SDK" offSpacer="" %}}
