---
title: Convertir PDF a HTML a través de Cloud Node.js SDK
url: nodejs/conversion/pdf-to-html/
description: Convierte PDFs en HTML responsivo usando Node.js y Aspose.PDF Cloud SDK. Perfecto para la visualización de documentos en línea.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF a HTML en Node.js SDK" h2="Exporta documentos PDF a múltiples formatos, incluyendo HTML con Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo Convertir PDF a HTML Usando Node.js SDK" %}}

Para convertir PDF a HTML, usaremos
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Este SDK en la nube ayuda a los programadores de Node.js a desarrollar aplicaciones en la nube para crear, anotar, editar y convertir PDFs usando el lenguaje de programación Node.js a través de Aspose.PDF REST API. Abre
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Convertir PDF a HTML a través de Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Los desarrolladores de Aspose.PDF Cloud Node.js pueden cargar y convertir fácilmente archivos PDF a HTML en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carga tu Secreto de Aplicación y Clave desde el archivo JSON o establece credenciales de otra manera
1. Crea un objeto para conectar con la API en la nube
1. Sube tu archivo de documento
1. Realiza la conversión usando getPdfInStorageToHtml
1. Descarga el resultado si es necesario

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la Conversión de PDF a HTML Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/emf-to-pdf/" name="EMF A PDF" description="Documento Words Office 2007+" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/epub-to-pdf/" name="EPUB A PDF" description="Formato Metafile Mejorado" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF A XLSX" description="Archivo de Formato de Hoja de Cálculo Abierto XML de Microsoft Excel" >}}
