---
title: 通过云 PHP SDK 创建 PDF
url: php/create/
description: Aspose.PDF Cloud 允许您创建 PDF 文档。查看 PHP 源代码以创建 PDF 文件。
lastmod: 2024-10-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 PHP SDK 中创建 PDF" h2="使用云 PHP SDK 创建 PDF 文档" logoImageSrc="/sdk/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="用于 PHP" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PDF Cloud " subTitlepfName="PHP 的 SDK" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="/sdk/aspose_pdf-for-php.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-pdf-cloud" liveDemosLink="https://products.aspose.cloud/pdf/" docsLink="https://docs.aspose.cloud/pdf/" installationsDocsLink="https://docs.aspose.cloud/pdf/" nugetLink="https://www.nuget.org/packages/Aspose.Pdf-Cloud" nugetPackageName="" downloadAsLink="https://releases.aspose.cloud/pdf/php/" learnAsLink="https://docs.aspose.cloud/pdf/" apiReference="https://reference.aspose.cloud/pdf/" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="如何通过云 PHP SDK 创建 PDF" %}}

要创建 PDF，我们将使用
[Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/)
此云 SDK 协助 PHP 程序员使用 PHP 编程语言通过 Aspose.PDF REST API 开发基于云的 PDF 创建、注释、编辑和转换应用程序。只需在 [Aspose for Cloud](https://dashboard.aspose.cloud/#/apps) 创建一个账户并获取您的应用程序信息。 一旦您拥有 App SID 和密钥，就可以开始使用 Aspose.PDF Cloud PHP SDK 了。
...
{{% blocks/products/pf/agp/feature-section-col title="通过云 PHP 创建 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud 开发者可以轻松加载并用几行代码创建 PDF。
...
1. 调用 createPdfDocument() 生成 PDF

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="使用 PHP 创建 PDF" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="使用我们的 PHP 库，您可以：" %}}

使用 [Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/) 创建 PDF 文档。
...
{{< blocks/products/pf/slr-tab tabTitle="为什么选择适用于PHP的Aspose.PDF Cloud?" tabId="success-stories" >}}
