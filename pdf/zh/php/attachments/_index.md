---
title: 通过 Aspose.Pdf Cloud PHP SDK 从 PDF 文档中提取或附加附件
url: php/attachments/
description: 在 PHP 应用程序中使用 Aspose.PDF Cloud 管理 PDF 文件附件。通过 REST API 添加、提取或删除嵌入文件。
lastmod: 2024-10-29
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PHP SDK 中的 PDF 附件" h2="使用 Aspose.PDF Cloud PHP SDK 处理 PDF 文档中的附件的 API" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Cloud PHP SDK 提取、附加和替换 PDF 文档中的附件" %}}

为了处理 PDF 文档中的附件，我们将使用
[Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/)
此 Cloud SDK SDK 帮助 PHP 程序员使用 PHP 编程语言通过 Aspose.PDF REST API 开发基于云的 PDF 创建、注释、编辑和转换应用程序。打开
