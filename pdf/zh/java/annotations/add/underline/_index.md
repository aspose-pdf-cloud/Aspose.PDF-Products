---
title: 通过云 Java SDK 为 PDF 添加下划线批注
url: java/annotations/underline/
description: 使用 Aspose.PDF Cloud Java SDK 在 PDF 文档中插入下划线文字批注。
lastmod: 2025-11-23
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="通过 Java SDK 为 PDF 文档添加下划线文字批注" h2="使用 Aspose.PDF Cloud Java SDK 为 PDF 文档添加下划线文字批注的 API。" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Cloud Java SDK 在 PDF 文档中插入下划线文字批注 " %}}

为了通过 Cloud Java SDK 为 PDF 文档添加批注，我们将使用
...
将 Aspose Cloud 仓库添加到应用程序的 pom.xml 中
...
Aspose.PDF Cloud 开发者只需几行代码即可轻松加载并追加批注到 PDF 文档。
...
{{% blocks/products/pf/agp/code-block title="此示例代码展示了向 PDF 文档添加下划线批注" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="通过 Java SDK 在 PDF 中处理批注" %}}

在 PDF 中添加批注在不同的使用场景中具有许多重要作用。最常见的原因之一是用于审阅和反馈。批注让用户能够突出文档的特定部分，留下评论，提出问题或建议更改。这使得审阅过程更加高效和有条理，尤其在有多个协作者参与时。
...
+ 通过 ID 删除 PDF 文档中的特定印章或表格。
+ 替换 PDF 页面或整个文档中的单个或多个文本实例。
+ 提供广泛的 PDF 文档转换为其他多种文件格式的支持。
