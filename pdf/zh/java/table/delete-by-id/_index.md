---
title: 通过云 Java SDK 从 PDF 中按 Id 删除表格
url: java/table/delete-by-id/
description: 使用 Aspose.PDF Cloud SDK for Java 按 Id 从 PDF 中删除表格。通过 Id 从文档中移除表格。
lastmod: 2025-11-10
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Java SDK 中通过 Id 从 PDF 删除表格" h2="使用服务器端 Java API 从 PDF 文档中按 Id 删除表格。" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何通过云 Java SDK 从 PDF 按 Id 删除表格 " %}}

为了通过云 Java SDK 从 PDF 按 Id 删除表格，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java SDK 从 PDF 按 Id 删除表格的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud 开发者可以轻松加载并通过几行代码从 PDF 中按 Id 删除表格。
...
1. 创建一个用于连接云 API 的对象。
1. 将 PDF 上传到云存储。
1. 使用 DeleteTableAsync 函数从云存储中的 PDF 按 Id 删除表格。
1. 检查响应并记录结果。
1. 下载更新后的文件以供本地使用。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="此示例代码演示了如何从 PDF 文档中按 Id 删除表格" offSpacer="" %}}
...
从文档中删除表格可能是必要的，例如当表格包含不需要的信息时，以简化文档；当表格包含个人数据、价格、联系人或其他敏感信息时，以确保机密性；准备复用时，如果文档需要作为模板；用于自动处理；在打印时进行优化；以及在表格过时或包含错误时进行编辑和更新信息。
使用 [Aspose.PDF Cloud Java SDK](https://products.aspose.cloud/pdf/java/) 按 Id 从 PDF 文档中删除表格。
