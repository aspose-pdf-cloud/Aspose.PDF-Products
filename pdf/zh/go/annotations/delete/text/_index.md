...
{{< blocks/products/pf/upper-banner h1="通过 Go SDK 从 PDF 中删除文本注释" h2="通过 Aspose.PDF Cloud Go SDK 删除 PDF 文档中的注释的 API" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Cloud Go SDK 删除 PDF 文档中的文本注释" %}}

为了从 PDF 文档中删除文本注释，我们将使用
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
此 Cloud SDK 帮助 Go 程序员使用 Go 编程语言通过 Aspose.PDF REST API 开发基于云的 PDF 创建、注释、编辑和转换应用程序。请使用以下命令从包管理器控制台中执行。
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Go 删除注释的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Go 开发人员可以轻松删除 PDF 文档中的注释。开发人员只需几行代码。

{{% /blocks/products/pf/agp/text %}}

1. 将文件上传到云存储。
1. 使用 DeletePageAnnotations() 删除文本注释。
1. 下载修改后的文档。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="此示例代码展示如何使用 PDF Cloud Go SDK 删除 PDF 文档中的文本注释" offSpacer="" %}}
...
+ 您可以尝试我们的[免费应用](https://products.aspose.app/pdf/)在线删除 PDF 文件中的注释并测试功能。
