---
title: 通过 Cloud Go SDK 按名称解析 PDF 以提取文本
url: go/parser/text-by-name/
description: 使用 Aspose.PDF Cloud SDK for Go 按名称解析 PDF 文件以提取文本。增强可发现性和索引。
lastmod: 2025-09-11
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="通过 Go SDK 按名称解析 PDF 以提取文本" h2="使用服务器端 Go API 按名称解析 PDF 文档以提取文本的 API。" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Cloud Go SDK 按名称解析 PDF 文档以提取文本" %}}

为了通过 Cloud Go SDK 按名称解析 PDF 文档以提取文本，我们将使用
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
这个 Cloud Go SDK 帮助 Go 程序员使用 Aspose.PDF REST API 开发基于云的 PDF 创建、注释、编辑、转换和解析应用程序。使用以下命令从包管理器控制台中执行。
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Go SDK 按名称解析 PDF 以提取文本的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud 开发人员可以轻松地按名称解析 PDF 文档以提取文本。开发人员只需几行代码。
...
1. 上传您的文档文件
1. 使用 GetTextBoxField 函数在云存储中按名称解析 PDF 文档以提取文本
1. 检查响应并记录结果
1. 如有需要，将文本框信息下载为本地 JSON 文件

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="此示例代码显示了按名称解析 PDF 文档以提取文本" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="通过 Go SDK 处理 PDF 中的文本解析" %}}

通过按名称解析 PDF 文档以提取文本，您可以根据需要修改文本框字段的内容。这保持了文本在文档中的位置，同时节省了时间并减少了手动工作。
使用 [Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/) 按名称解析 PDF 文档以提取文本。
