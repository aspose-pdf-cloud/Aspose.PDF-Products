---
title: 通过 Cloud Go SDK 将 EPUB 转换为 PDF
url: go/conversion/epub-to-pdf/
description: 使用 Aspose.PDF Cloud SDK 在您的 Go 应用程序中将 EPUB 转换为 PDF。非常适合电子书存档。
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Go SDK 中将 EPUB 转换为 PDF" h2="使用 Aspose.PDF Cloud Go SDK 将 EPUB 文档导出为包括 PDF 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Go SDK 将 EPUB 转换为 PDF" %}}

要将 EPUB 转换为 PDF，我们将使用
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
这个 Cloud SDK 帮助 Go 程序员使用 Aspose.PDF REST API 开发基于云的 PDF 创建、注释、编辑和转换应用程序。请在包管理器控制台中使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Go 将 EPUB 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Go 开发人员可以轻松地在几行代码中加载和转换 EPUB 文件为 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 将 EPUB 文件上传到 Aspose Cloud 存储。
1. 将 EPUB 转换为 PDF。
1. 将输出的 PDF 保存到云存储中。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="此示例代码展示了 EPUB 到 PDF 的 Cloud Go SDK 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/gif-to-pdf/" name="GIF 转 PDF" description="图形互换格式" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/pdf-to-gif/" name="PDF 转 GIF" description="图形互换格式" >}}
