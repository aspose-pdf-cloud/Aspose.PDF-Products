---
title: 通过 Cloud Go SDK 将 PDF 转换为 XLS
url: go/conversion/pdf-to-xls/
description: 使用 Aspose.PDF Cloud SDK for Go 将 PDF 导出为 XLS。
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Go SDK 中将 PDF 转换为 XLS" h2="使用 Aspose.PDF Cloud Go SDK 将 PDF 文档导出为多种格式，包括 XLS" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Go SDK 将 PDF 转换为 XLS" %}}

要将 PDF 转换为 XLS，我们将使用
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
此云 SDK 帮助 Go 程序员使用 Go 编程语言通过 Aspose.PDF REST API 开发基于云的 PDF 创建、注释、编辑和转换应用程序。请从程序包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Go 将 PDF 转换为 XLS 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Go 开发人员可以轻松地在几行代码中加载并转换 PDF 到 XLS。

{{% /blocks/products/pf/agp/text %}}

1. 将 PDF 文件上传到 Aspose 云存储。
1. 将 PDF 转换为 XLS 格式。
1. 将输出的 XLS 保存到云存储中。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="此示例代码显示了 PDF 到 XLS 云 Go SDK 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以转换许多其他文件格式，包括以下列出的几个。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/pcl-to-pdf/" name="PCL 转 PDF" description="打印机控制语言" >}}
