...
{{% blocks/products/pf/agp/content h2="如何使用 Go SDK 将 MHTML 转换为 PDF" %}}

要将 MHTML 转换为 PDF，我们将使用
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
这个 Cloud SDK SDK 帮助 Go 程序员使用 Go 编程语言通过 Aspose.PDF REST API 开发基于云的 PDF 创建、注释、编辑和转换应用程序。使用以下命令从包管理器控制台执行。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Go 将 MHTML 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Go 开发者可以轻松地在几行代码中加载并转换 MHTML 文件为 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 将 MHTML 文件上传到 Aspose Cloud 存储。
1. 将 MHTML 转换为 PDF。
1. 将输出 PDF 保存在云存储中。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="此示例代码展示了 MHTML 到 PDF 的 Cloud Go SDK 转换" offSpacer="" %}}
