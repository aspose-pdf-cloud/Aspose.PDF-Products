---
title: 通过 Cloud Go SDK 将 PNG 转换为 PDF
url: go/conversion/png-to-pdf/
description: 使用 Go 和 Aspose.PDF Cloud 将 PNG 图像转换为 PDF。快速、高质量的图像转换。
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Go SDK 中将 PNG 转换为 PDF" h2="使用 Aspose.PDF Cloud Go SDK 将 PNG 文档导出为包括 PDF 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Go SDK 将 PNG 转换为 PDF" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Go 将 PNG 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Go 开发人员可以轻松地在几行代码中加载并将 PNG 文件转换为 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 将 PNG 文件上传到 Aspose 云存储。
1. 将 PNG 转换为 PDF。
1. 将输出 PDF 保存在云存储中。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="此示例代码显示 PNG 到 PDF 云 Go SDK 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以转换许多其他文件格式，包括以下列出的几种。" >}}
