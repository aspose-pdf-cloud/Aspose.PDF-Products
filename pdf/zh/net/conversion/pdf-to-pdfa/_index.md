---
title: 通过Cloud .NET SDK将PDF转换为PDF/A
url: net/conversion/pdf-to-pdfa/
description: 使用Aspose.PDF Cloud SDK for .NET将PDF转换为PDF/A格式以便存档。符合长期存储要求。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在.NET SDK中将PDF转换为PDF/A" h2="使用Aspose.PDF Cloud .NET SDK将PDF文档转换为PDF/A格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用.NET SDK将PDF转换为PDF/A" %}}

为了将PDF转换为PDF/A，我们将使用
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
这个Cloud SDK允许您轻松在C#、ASP.NET或其他.NET语言中构建基于云的PDF创建、编辑和转换应用程序，用于各种云平台。打开
...
{{% blocks/products/pf/agp/feature-section-col title="通过.NET SDK将PDF转换为PDF/A的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud开发者可以仅用几行代码轻松加载和转换PDF为PDF/A文件。
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示PDF到PDF/A的Cloud .NET SDK转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/jpeg-to-pdf/" name="JPEG TO PDF" description="JPEG图像" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-docx/" name="PDF TO DOCX" description="Office 2007+ Word文档" >}}
