---
title: 通过云端 .NET SDK 将PDF转换为HTML
url: net/conversion/pdf-to-html/
description: 使用Aspose.PDF Cloud SDK for .NET将PDF转换为HTML页面。实现网络友好的文档查看。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 .NET SDK 中将PDF转换为HTML" h2="使用Aspose.PDF Cloud .NET SDK将PDF文档转换为HTML格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 .NET SDK 将PDF转换为HTML" %}}

为了将PDF转换为HTML，我们将使用
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
此云端SDK允许您轻松构建基于云的PDF创建、编辑和转换应用程序，适用于C#、ASP.NET或其他.NET语言的各种云平台。打开
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET SDK 将PDF转换为HTML的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud开发人员可以通过几行代码轻松加载和转换PDF到HTML文件。
...
{{% blocks/products/pf/agp/code-block title="此示例代码演示PDF到HTML云端.NET SDK转换" offSpacer="" %}}
