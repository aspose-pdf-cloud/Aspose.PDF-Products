---
title: 通过 Cloud .NET SDK 将 EPUB 转换为 PDF
url: net/conversion/epub-to-pdf/
description: 使用 Aspose.PDF Cloud SDK for .NET 将 EPUB 电子书转换为 PDF。非常适合数字出版工作流程。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 .NET SDK 中将 EPUB 转换为 PDF" h2="使用 Aspose.PDF Cloud .NET SDK 将 EPUB 文档导出为包括 PDF 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 .NET SDK 将 EPUB 转换为 PDF" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET SDK 将 EPUB 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud 开发人员可以轻松加载并转换 EPUB 文件为 PDF，仅需几行代码。
...
{{% blocks/products/pf/agp/code-block title="此示例代码展示了 EPUB 到 PDF Cloud .NET SDK 转换" offSpacer="" %}}
