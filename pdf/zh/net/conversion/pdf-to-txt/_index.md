---
title: 通过 Cloud .NET SDK 将 PDF 转换为 TXT
url: net/conversion/pdf-to-txt/
description: 使用 Aspose.PDF Cloud SDK for .NET 将 PDF 中的文本导出为 TXT 格式。输出轻量且可搜索。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 .NET SDK 中将 PDF 转换为 TXT" h2="使用 Aspose.PDF Cloud .NET SDK 将 PDF 文档转换为 TXT 格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 .NET SDK 将 PDF 转换为 TXT" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET SDK 将 PDF 转换为 TXT 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud 开发人员可以轻松地在几行代码中加载并将 PDF 转换为 TXT 文件。
...
{{% blocks/products/pf/agp/code-block title="此示例代码展示了 PDF 到 TXT 的 Cloud .NET SDK 转换" offSpacer="" %}}
