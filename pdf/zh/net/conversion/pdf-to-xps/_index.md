---
title: 通过云端 .NET SDK 转换 PDF 为 XPS
url: net/conversion/pdf-to-xps/
description: 使用 Aspose.PDF Cloud SDK for .NET 将 PDF 文件转换为 XPS 文档。保留布局和矢量数据。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 .NET SDK 中转换 PDF 为 XPS" h2="使用 Aspose.PDF Cloud .NET SDK 将 PDF 文档转换为 XPS 格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 .NET SDK 将 PDF 转换为 XPS" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET SDK 转换 PDF 为 XPS 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud 开发人员可以轻松地在几行代码中加载并转换 PDF 为 XPS 文件。
...
{{% blocks/products/pf/agp/code-block title="此示例代码展示了 PDF 到 XPS 的云 .NET SDK 转换" offSpacer="" %}}
