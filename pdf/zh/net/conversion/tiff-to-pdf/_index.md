---
title: 通过 Cloud .NET SDK 将 TIFF 转换为 PDF
url: net/conversion/tiff-to-pdf/
description: 使用 Aspose.PDF Cloud SDK for .NET 将 TIFF 图像文件转换为 PDF。适用于扫描文档存档。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 .NET SDK 中将 TIFF 转换为 PDF" h2="使用 Aspose.PDF Cloud .NET SDK 将 TIFF 文档导出为包括 PDF 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 .NET SDK 将 TIFF 转换为 PDF" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET SDK 将 TIFF 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud 开发人员可以轻松加载和转换 TIFF 文件为 PDF，只需几行代码。
...
{{% blocks/products/pf/agp/code-block title="此示例代码展示了 TIFF 到 PDF 的 Cloud .NET SDK 转换" offSpacer="" %}}
