---
title: 通过云端 Node.js SDK 将 XPS 转换为 PDF
url: nodejs/conversion/xps-to-pdf/
description: 使用 Node.js 和 Aspose.PDF Cloud 将 XPS 文档转换为 PDF。提升文件的可访问性和兼容性。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Node.js SDK 中将 XPS 转换为 PDF" h2="使用 Aspose.PDF Cloud Node.js SDK 将 XPS 文档导出为包括 PDF 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Node.js SDK 将 XPS 转换为 PDF" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Node.js 将 XPS 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js 开发人员可以轻松地在几行代码中加载和转换 XPS 文件为 PDF。
...
1. 创建一个对象以连接到云 API
1. 上传您的文档文件
1. 使用 putXpsInStorageToPdf 执行转换
1. 如果需要，请下载结果

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="此示例代码显示了 XPS 到 PDF 的云 Node.js SDK 转换" offSpacer="" %}}
