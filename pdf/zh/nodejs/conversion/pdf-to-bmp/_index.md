---
title: 通过云端 Node.js SDK 将 PDF 转换为 BMP
url: nodejs/conversion/pdf-to-bmp/
description: 使用 Aspose.PDF Cloud SDK for Node.js 将 PDF 转换为 BMP 图像格式。高分辨率图像输出。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Node.js SDK 中将 PDF 转换为 BMP" h2="使用 Aspose.PDF Cloud Node.js SDK 导出 PDF 文档为包括 BMP 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Node.js SDK 将 PDF 转换为 BMP" %}}

为了将 PDF 转换为 BMP，我们将使用
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
此 Cloud SDK SDK 帮助 Node.js 程序员通过 Aspose.PDF REST API 使用 Node.js 编程语言开发云端 PDF 创建、注释、编辑和转换应用程序。打开
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Node.js 将 PDF 转换为 BMP 的步骤" %}}
...
1. 创建一个对象以连接到云 API
1. 上传您的文档文件
1. 使用 getPageConvertToBmp 执行转换
1. 如有需要，下载结果

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="此示例代码显示 PDF 到 BMP 的云 Node.js SDK 转换" offSpacer="" %}}
