---
title: 通过云端 Node.js SDK 将 PDF 转换为 PDF/A
url: nodejs/conversion/pdf-to-pdfa/
description: 使用 Aspose.PDF Cloud SDK for Node.js 将 PDF 存档为 PDF/A 格式。确保长期合规性。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Node.js SDK 中将 PDF 转换为 PDF/A" h2="使用 Aspose.PDF Cloud Node.js SDK 将 PDF 文档导出为多种格式，包括 PDF/A" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Node.js SDK 将 PDF 转换为 PDF/A" %}}

要将 PDF 转换为 PDF/A，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Node.js 将 PDF 转换为 PDF/A 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js 开发人员只需几行代码即可轻松加载和转换 PDF 文件为 PDF/A。
...
1. 创建一个对象以连接到云 API
1. 上传您的文档文件
1. 使用 getPdfInStorageToPdfA 执行转换
1. 如有需要，下载结果

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="此示例代码展示了 PDF 到 PDF/A 云 Node.js SDK 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以将 MD 转换为包括下列在内的许多其他文件格式。" >}}
