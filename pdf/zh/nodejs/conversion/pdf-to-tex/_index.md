---
title: 通过云端 Node.js SDK 将 PDF 转换为 TEX
url: nodejs/conversion/pdf-to-tex/
description: 使用 Aspose.PDF Cloud for Node.js 将 PDF 转换为 TeX 源代码。集成到 LaTeX 工作流中。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Node.js SDK 中将 PDF 转换为 TEX" h2="使用 Aspose.PDF Cloud Node.js SDK 将 PDF 文档导出为包括 TEX 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Node.js SDK 将 PDF 转换为 TEX" %}}

为了将 PDF 转换为 TEX，我们将使用
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
这个 Cloud SDK SDK 通过 Aspose.PDF REST API 帮助 Node.js 程序员开发基于云的 PDF 创建、注释、编辑和转换应用程序。打开
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Node.js 转换 PDF 为 TEX 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js 开发者可以轻松地在几行代码中加载和转换 PDF 文件为 TEX。
...
1. 创建一个对象以连接到云 API
1. 上传您的文档文件
1. 使用 getPdfInStorageToTeX 执行转换
1. 如果需要，下载结果

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="此示例代码显示 PDF 到 TEX 的云端 Node.js SDK 转换" offSpacer="" %}}
