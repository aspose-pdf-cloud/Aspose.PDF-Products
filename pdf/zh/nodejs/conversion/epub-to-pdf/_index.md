---
title: 通过云端 Node.js SDK 将 EPUB 转换为 PDF
url: nodejs/conversion/epub-to-pdf/
description: 使用 Aspose.PDF Cloud SDK 在您的 Node.js 应用程序中将 EPUB 转换为 PDF。非常适合电子书归档。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Node.js SDK 中将 EPUB 转换为 PDF" h2="使用 Aspose.PDF Cloud Node.js SDK 将 EPUB 文档导出为包括 PDF 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Node.js SDK 将 EPUB 转换为 PDF" %}}

要将 EPUB 转换为 PDF，我们将使用
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
此 Cloud SDK SDK 帮助 Node.js 程序员通过 Aspose.PDF REST API 使用 Node.js 编程语言开发基于云的 PDF 创建、注释、编辑和转换应用程序。打开
[NPM](https://www.npmjs.com/package/asposepdfcloud)
包管理器，搜索
Aspose.PDF Cloud,
并安装。您还可以使用以下命令从包管理器控制台中使用。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Node.js 将 EPUB 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js 开发人员可以通过几行代码轻松加载和转换 EPUB 文件为 PDF。
...
1. 创建一个对象以连接到云 API
1. 上传您的文档文件
1. 使用 putEpubInStorageToPdf 执行转换
1. 如有需要，下载结果

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="此示例代码显示 EPUB 到 PDF 云 Node.js SDK 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以将 MD 转换为许多其他文件格式，包括以下几种。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xps/" name="PDF 转 XPS" description="XML纸张规格" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/xps-to-pdf/" name="XPS 转 PDF" description="XML纸张规格" >}}
