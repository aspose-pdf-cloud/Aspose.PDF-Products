---
title: 通过云端 Node.js SDK 将 LATEX 转换为 PDF
url: nodejs/conversion/latex-to-pdf/
description: 使用 Aspose.PDF Cloud 在 Node.js 中将 LaTeX 文档转换为 PDF。非常适合学术和技术出版。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Node.js SDK 中将 LATEX 转换为 PDF" h2="使用 Aspose.PDF Cloud Node.js SDK 将 LATEX 文档导出为包括 PDF 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Node.js SDK 将 LATEX 转换为 PDF" %}}

为了将 LATEX 转换为 PDF，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Node.js 将 LATEX 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js 开发者可以轻松地在几行代码中加载并转换 LATEX 文件为 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 从 JSON 文件中加载您的应用程序密钥和密钥，或以其他方式设置凭证
1. 创建一个对象以连接到 Cloud API
1. 上传您的文档文件
1. 使用 putTeXInStorageToPdf 执行转换
1. 如果需要，下载结果

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="此示例代码展示了 LATEX 到 PDF 的 Cloud Node.js SDK 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以将 MD 转换为许多其他文件格式，包括以下列出的几种。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF 转 XLSX" description="微软Excel开放XML电子表格文件格式" >}}
