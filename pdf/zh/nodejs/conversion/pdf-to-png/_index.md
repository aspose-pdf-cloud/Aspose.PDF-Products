---
title: 通过云端 Node.js SDK 将 PDF 转换为 PNG
url: nodejs/conversion/pdf-to-png/
description: 使用 Node.js 和 Aspose.PDF Cloud SDK 将 PDF 文档转换为 PNG。保持图像清晰度和分辨率。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Node.js SDK 中将 PDF 转换为 PNG" h2="使用 Aspose.PDF Cloud Node.js SDK 将 PDF 文档导出为包括 PNG 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Node.js SDK 将 PDF 转换为 PNG" %}}

要将 PDF 转换为 PNG，我们将使用
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
此 Cloud SDK SDK 协助 Node.js 程序员使用 Node.js 编程语言通过 Aspose.PDF REST API 开发基于云的 PDF 创建、注释、编辑和转换应用程序。打开
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Node.js 将 PDF 转换为 PNG 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js 开发人员可以仅用几行代码轻松加载和转换 PDF 文件为 PNG。
...
1. 上传您的文档文件
1. 使用 getPageConvertToPng 执行转换
1. 如有需要，下载结果

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="该示例代码展示了 PDF 到 PNG 云端 Node.js SDK 的转换" offSpacer="" %}}
