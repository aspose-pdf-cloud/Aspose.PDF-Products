---
title: 通过云端 Node.js SDK 将 PDF 转换为 XLSX
url: nodejs/conversion/pdf-to-xlsx/
description: 使用 Aspose.PDF Cloud SDK for Node.js 将 PDF 表格和内容导出到 Excel XLSX。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Node.js SDK 中将 PDF 转换为 XLSX" h2="使用 Aspose.PDF Cloud Node.js SDK 将 PDF 文档导出为包括 XLSX 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Node.js SDK 将 PDF 转换为 XLSX" %}}

要将 PDF 转换为 XLSX，我们将使用
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
此云 SDK 帮助 Node.js 程序员使用 Aspose.PDF REST API 开发基于云的 PDF 创建、注释、编辑和转换应用程序。在
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Node.js 转换 PDF 到 XLSX 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js 开发人员可以轻松地用几行代码加载并转换 PDF 文件到 XLSX。
...
1. 创建一个对象以连接到云 API
1. 上传您的文档文件
1. 使用 etPdfInStorageToXlsx 执行转换
1. 如果需要，下载结果

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="此示例代码展示了 PDF 到 XLSX 云 Node.js SDK 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/jpeg-to-pdf/" name="JPEG 转 PDF" description="联合图像专家组格式" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-pptx/" name="PDF 转 PPTX" description="Microsoft PowerPoint" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-word/" name="PDF 转 WORD" description="Microsoft Word 二进制格式" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF 转 XLSX" description="Microsoft Excel Open XML 格式电子表格文件" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/text-to-pdf/" name="TEXT 转 PDF" description="文本文档" >}}
