---
title: 通过云端 Node.js SDK 将 PDF 转换为 HTML
url: nodejs/conversion/pdf-to-html/
description: 使用 Node.js 和 Aspose.PDF Cloud SDK 将 PDF 转换为响应式 HTML。非常适合在线文档展示。
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 Node.js SDK 中将 PDF 转换为 HTML" h2="使用 Aspose.PDF Cloud Node.js SDK 将 PDF 文档导出为包括 HTML 在内的多种格式" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Node.js SDK 将 PDF 转换为 HTML" %}}

为了将 PDF 转换为 HTML，我们将使用
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
这个 Cloud SDK 帮助 Node.js 程序员通过 Aspose.PDF REST API 使用 Node.js 编程语言开发基于云的 PDF 创建、注释、编辑和转换应用程序。 打开
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Node.js 将 PDF 转换为 HTML 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.PDF Cloud Node.js 开发者可以轻松地在几行代码中加载和转换 PDF 文件为 HTML。
...
1. 创建一个对象以连接到云 API
1. 上传您的文档文件
1. 使用 getPdfInStorageToHtml 执行转换
1. 如有需要，下载结果

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="这个示例代码显示 PDF 到 HTML 的 Cloud Node.js SDK 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以将 MD 转换为多种其他文件格式，包括下面列出的一些格式。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/jpeg-to-pdf/" name="JPEG 转 PDF" description="联合照片专家组" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pcl-to-pdf/" name="PCL 转 PDF" description="打印机控制语言" >}}
