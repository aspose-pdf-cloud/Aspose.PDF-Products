...
{{% blocks/products/pf/agp/feature-section-col title="Passos para substituir Links em PDF via Python SDK" %}}
...
1. Mostre todas as anotações de hyperlink para um documento PDF específico
1. Obtenha todas as anotações de hyperlink para um documento PDF específico
1. Substitua a anotação de link
...
É fácil começar com o Aspose.PDF Cloud Python SDK e não há nada para instalar. Simplesmente crie uma conta no Aspose for Cloud e obtenha as informações do seu aplicativo. Uma vez que você tenha o App SID & key, você está pronto para usar o Aspose.PDF Cloud Python SDK.
...
{{% blocks/products/pf/agp/code-block title="Substituir Links em PDF usando Python" offSpacer="" %}}
...
Substitua os links em documentos PDF com [Aspose.PDF Cloud Python SDK](https://products.aspose.cloud/pdf/python/).
