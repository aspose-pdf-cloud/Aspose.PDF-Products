---
title: Adicionar Assinatura a PDF via Cloud PHP SDK
url: php/signature/add/
description: O Aspose.PDF Cloud permite adicionar uma Assinatura a um Documento PDF. Verifique o código-fonte PHP para adicionar uma Assinatura ao arquivo PDF.
lastmod: 2025-03-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Assinar PDF no PHP SDK" h2="Adicionar uma Assinatura a um Documento PDF usando Cloud PHP SDK" logoImageSrc="/sdk/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="para PHP" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para adicionar assinatura a PDF via Cloud PHP" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud podem facilmente carregar & adicionar assinatura ao PDF com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar um Documento PDF
1. Carrega o documento PDF especificado na configuração
1. Baixa o resultado do processamento do documento PDF e o salva no local especificado
1. Anexa uma assinatura digital ao documento PDF

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Adicionar assinatura a PDF usando PHP" offSpacer="" %}}
