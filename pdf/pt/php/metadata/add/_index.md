---
title: Adicionar Metadados via Cloud PHP SDK
url: php/metadata/add/
description: Adicione metadados a arquivos PDF em PHP usando Aspose.PDF Cloud SDK. Marque documentos para melhor indexação e pesquisa.
lastmod: 2024-03-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Adicionar Metadados ao PDF no PHP SDK" h2="Adicionar Metadados a um Documento PDF usando o Cloud PHP SDK." logoImageSrc="/sdk/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="para PHP" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Como criar Metadados via Cloud PHP SDK" %}}

Para criar Metadados, usaremos
[Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/)
Este Cloud SDK auxilia programadores PHP a desenvolver aplicativos baseados em nuvem para criar, anotar, editar e converter PDFs usando a linguagem de programação PHP via Aspose.PDF REST API. Simplesmente crie uma conta no [Aspose for Cloud](https://dashboard.aspose.cloud/#/apps) e obtenha as informações do seu aplicativo. Uma vez que você tenha o App SID e a chave, você está pronto para usar o Aspose.PDF Cloud PHP SDK.
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para criar Metadados via Cloud PHP SDK" %}}

{{% blocks/products/pf/agp/text %}}

Um programa básico para adicionar metadados em PDFs programaticamente com
[Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/)
...
1. Consulte o [Guia do Desenvolvedor](https://docs.aspose.cloud/pdf/developer-guide/) para criar Metadados em PDF em PHP.
1. Confira nosso [repositório GitHub](https://github.com/aspose-pdf-cloud/aspose-pdf-cloud-php) para uma lista completa de APIs com exemplos práticos.
...
É fácil começar com o Aspose.PDF Cloud PHP SDK e não há nada para instalar. Simplesmente crie uma conta no Aspose for Cloud e obtenha as informações do seu aplicativo. Uma vez que você tenha o App SID e a chave, você está pronto para usar o Aspose.PDF Cloud PHP SDK.
...
{{% blocks/products/pf/agp/code-block title="Criar Propriedades de Metadados XMP em PDF usando PHP" offSpacer="" %}}
...
Os metadados também melhoram a busca de arquivos, permitindo que você pesquise por palavras-chave e atributos. Isso é particularmente valioso em sistemas onde a rápida recuperação de documentos é essencial.
...
+ Você pode experimentar nosso [App gratuito](https://products.aspose.app/pdf/metadata) para adicionar metadados em arquivos PDF online e testar a funcionalidade.
