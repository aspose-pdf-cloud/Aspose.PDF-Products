---
title: Obter Metadados de Documento PDF via Cloud PHP SDK
url: php/metadata/get/
description: Recuperar informações de metadados de documentos PDF usando PHP com Aspose.PDF Cloud SDK.
lastmod: 2024-03-19
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Obter Metadados de PDF no PHP SDK" h2="Obtenha todos os metadados dos documentos PDF usando Cloud PHP SDK." logoImageSrc="/sdk/aspose_pdf-for-php.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="para PHP" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Como Obter Metadados de Documento PDF usando Cloud PHP SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para obter Metadados via Cloud PHP SDK" %}}

{{% blocks/products/pf/agp/text %}}

Um programa básico para obter metadados de PDFs programaticamente com
[Aspose.PDF Cloud PHP SDK](https://products.aspose.cloud/pdf/php/)
...
1. Consulte o [Guia do Desenvolvedor](https://docs.aspose.cloud/pdf/developer-guide/) para obter Metadados em PDF em PHP.
1. Confira nosso [repositório no GitHub](https://github.com/aspose-pdf-cloud/aspose-pdf-cloud-php) para uma lista completa de APIs juntamente com exemplos funcionais.
1. Consulte a [página de Referência de API](https://reference.aspose.cloud/pdf/#/Document) para a descrição dos parâmetros das APIs.

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra como obter Metadados de um PDF usando PHP" offSpacer="" %}}
...
Trabalhar com metadados em arquivos PDF é importante. Metadados como o campo título, autor e tema ajudam a classificar documentos, tornando mais fácil gerenciar grandes coleções de documentos ao fornecer uma visão rápida do conteúdo sem abrir os arquivos.
Os metadados também melhoram a busca de arquivos ao permitir que você pesquise por palavras-chave e atributos. Isso é particularmente valioso em sistemas onde a recuperação rápida de documentos é essencial.
