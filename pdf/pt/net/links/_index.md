---
title: Manipular Links em PDF via Cloud .NET SDK
url: net/links/
description: Trabalhe com Links em PDF usando Aspose.PDF Cloud SDK para .NET.
lastmod: 2025-08-14
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Trabalhe com Links em PDF via .NET SDK" h2="API para trabalhar com Links em documentos PDF com .NET." logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
<div class="row">
<div class="container">
<h2 class="pr-ft">Ações mais populares com Links em .NET</h2>
<div class="col-lg-4">
<em class="fa fa-picture-o ico-blue fa-2x col-lg-2"></em>
<p class="col-lg-10"><a href="https://products.aspose.cloud/pdf/net/links/add/">Adicionar Links ao PDF</a></p>
</div>
<div class="col-lg-4">
<em class="fa fa-file-text ico-blue fa-2x col-lg-2"></em>
<p class="col-lg-10"><a href="https://products.aspose.cloud/pdf/net/links/get/">Obter Links do PDF</a></p>
</div>
<div class="col-lg-4">
<em class="fa fa-file-text ico-blue fa-2x col-lg-2"></em>
<p class="col-lg-10"><a href="https://products.aspose.cloud/pdf/net/links/delete/">Excluir Links no PDF</a></p>
</div>
</div>
</div>
</div>

{{% blocks/products/pf/agp/content h2="Como trabalhar com Links em documentos PDF usando Cloud .NET SDK " %}}

Para manipular Links em documentos PDF via Cloud .NET SDK, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para adicionar links usando .NET SDK" %}}
...
1. Criar novos objetos de anotação de link
1. Adicionar um novo objeto de anotação de links ao PDF no armazenamento em nuvem usando a função PostPageLinkAnnotationsAsync.
1. Verifica a resposta e registra o resultado.
1. Baixa o arquivo atualizado para uso local.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra como adicionar links ao documento PDF" offSpacer="" %}}
