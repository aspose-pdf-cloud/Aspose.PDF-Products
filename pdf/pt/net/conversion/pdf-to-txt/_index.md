---
title: Converter PDF para TXT via Cloud .NET SDK
url: net/conversion/pdf-to-txt/
description: Exporte texto de PDF para formato TXT usando o Aspose.PDF Cloud SDK para .NET. Resultado leve e pesquisável.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para TXT no .NET SDK" h2="Converta documentos PDF para formato TXT com Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para TXT Usando SDK para .NET" %}}

Para converter PDF para TXT, usaremos
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
Este SDK Cloud permite que você crie facilmente aplicativos de criação, edição e conversão de PDF baseados em nuvem em C#, ASP.NET ou outras linguagens .NET para várias plataformas em nuvem. Abra
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para Converter PDF para TXT via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud podem carregar e converter facilmente arquivos PDF para TXT em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão PDF para TXT Cloud .NET SDK" offSpacer="" %}}
