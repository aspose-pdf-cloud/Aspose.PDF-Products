---
title: Converter PDF para Microsoft Word DOCX via Cloud .NET SDK
url: net/conversion/pdf-to-docx/
description: Converta PDF em documentos DOCX editáveis com Aspose.PDF Cloud SDK para .NET. Preserve o layout e a estrutura do texto.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para DOCX no .NET SDK" h2="Converter documentos PDF para formato DOCX com Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
Este Cloud SDK permite construir facilmente aplicativos de criação, edição e conversão de PDF baseados em nuvem em C#, ASP.NET ou outras linguagens .NET para várias plataformas de nuvem. Abra
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PDF em DOCX via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud podem carregar e converter arquivos PDF em DOCX facilmente com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Crie um novo objeto de Configuração com seu Segredo de Aplicativo e Chave
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para DOCX com Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-docx/" name="PDF PARA DOCX" description="Documento de Palavra Office 2007+" >}}
