---
title: Converter JPEG para PDF via Cloud .NET SDK
url: net/conversion/jpeg-to-pdf
description: Converta imagens JPEG em PDFs usando o Aspose.PDF Cloud SDK para .NET. Mescle, organize e otimize documentos de imagem.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter JPEG para PDF em .NET SDK" h2="Exporte documentos JPEG para múltiplos formatos, incluindo PDF, com Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter JPEG para PDF Usando SDK para .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter JPEG para PDF via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud podem facilmente carregar e converter arquivos JPEG para PDF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de JPEG para PDF no Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-docx/" name="PDF PARA DOCX" description="Documento do Microsoft Word 2007+" >}}
