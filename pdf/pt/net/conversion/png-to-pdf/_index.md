---
title: Converter PNG para PDF via Cloud .NET SDK
url: net/conversion/png-to-pdf/
description: Converta imagens PNG para PDF com Aspose.PDF Cloud SDK para .NET. Crie documentos portáteis a partir de ativos de imagem.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PNG para PDF no .NET SDK" h2="Exporte documentos PNG para múltiplos formatos, incluindo PDF, com Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PNG para PDF Usando SDK para .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para Converter PNG para PDF via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud podem facilmente carregar e converter arquivos PNG para PDF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PNG para PDF no Cloud .NET SDK" offSpacer="" %}}
