---
title: Converter PDF para Microsoft Excel XLSX via Cloud .NET SDK
url: net/conversion/pdf-to-xlsx/
description: Converta PDF para Excel XLSX com Aspose.PDF Cloud SDK para .NET. Extração de dados estruturados simplificada.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para XLSX no .NET SDK" h2="Converta documentos PDF para formato XLSX com Aspose.PDF Cloud .NET SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para XLSX Usando SDK para .NET" %}}

Para converter PDF para XLSX, usaremos
[Aspose.PDF Cloud .NET SDK](https://products.aspose.cloud/pdf/net/)
Este Cloud SDK permite que você crie facilmente aplicativos baseados em nuvem para criação, edição e conversão de PDF em C#, ASP.NET ou outras linguagens .NET para várias plataformas de nuvem. Abra
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PDF para XLSX via .NET SDK" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud podem facilmente carregar e converter arquivos PDF para XLSX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para XLSX com o Cloud .NET SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/emf-to-pdf/" name="EMF PARA PDF" description="Formato Metafile Aprimorado" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-docx/" name="PDF PARA DOCX" description="Documento Words do Office 2007+" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/net/conversion/pdf-to-emf/" name="PDF PARA EMF" description="Formato Metafile Aprimorado" >}}
