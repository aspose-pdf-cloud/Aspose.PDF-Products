...
{{% blocks/products/pf/agp/content h2="Como extrair Favoritos de PDF via Cloud Python SDK " %}}

Para extrair Favoritos de PDF, usaremos [Aspose.PDF Cloud Python SDK](https://products.aspose.cloud/pdf/python/). Este Cloud SDK auxilia programadores Python no desenvolvimento de aplicativos baseados em nuvem para criar, anotar, editar e converter PDFs usando a linguagem de programação Python via Aspose.PDF REST API. Basta criar uma conta no [Aspose para Cloud](https://dashboard.aspose.cloud/#/apps) e obter as informações do seu aplicativo. Uma vez que você tenha o SID & chave do App, você está pronto para usar o Aspose.PDF Cloud Python SDK. Se o pacote Python estiver hospedado no Github, você pode instalar diretamente do Github:
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para obter Favoritos de PDF via Python SDK" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud podem facilmente carregar e extrair Favoritos de PDF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Instale [Python SDK](https://pypi.org/project/asposepdfcloud/)
1. Faça upload de um documento PDF para o servidor Aspose Cloud
1. Obtenha o favorito para um documento PDF específico usando o caminho do favorito

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Extrair Favoritos de PDF usando Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Trabalhar com Favoritos em PDF" %}}
...
Extraia os Favoritos de documentos PDF com [Aspose.PDF Cloud Python SDK](https://products.aspose.cloud/pdf/python/).
