---
title: Anexar anexos em documentos PDF via Aspose.Pdf Cloud Python SDK
url: python/attachments/add/
description: Adicione anexos a arquivos PDF usando Python e Aspose.PDF Cloud SDK. Incorpore documentos, imagens e mais.
lastmod: 2024-10-29
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Adicionar Anexos ao PDF no Python SDK" h2="API para adicionar anexos em documentos PDF com Aspose.PDF Cloud Python SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para adicionar anexos via Python SDK" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud Python podem facilmente anexar anexos em documentos PDF. Os desenvolvedores precisam de apenas algumas linhas de código.
...
1. Defina o nome com o caminho do arquivo do seu documento
1. Realize as ações de anexar anexo
1. Se for bem-sucedido, o PDF modificado é baixado e salvo em um arquivo especificado
1. Se ocorrerem erros durante o processo, eles são capturados e impressos

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra como anexar arquivo ao documento PDF usando PDF Cloud Python SDK" offSpacer="" %}}
