---
title: Extrair anexos de documentos PDF via Aspose.Pdf Cloud Python SDK
url: python/attachments/get/
description: Recuperar anexos de PDFs com Python e Aspose.PDF Cloud SDK. Acesse conteúdo incorporado de forma eficiente.
lastmod: 2024-10-29
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extrair Anexos de PDF no Python SDK" h2="API para extrair anexos em documentos PDF com Aspose.PDF Cloud Python SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como extrair anexos de documentos PDF usando o Cloud Python SDK" %}}

Para trabalhar com anexos em documentos PDF, usaremos
[Aspose.PDF Cloud Python SDK](https://products.aspose.cloud/pdf/python/)
Este SDK em nuvem ajuda programadores Python a desenvolver aplicativos baseados em nuvem para criar, anotar, editar e converter PDFs usando a linguagem de programação Python via Aspose.PDF REST API. Abra
...
1. Execute as ações de extração de anexos
1. A resposta da função da API de Nuvem conterá uma lista de anexos
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a extração de todos os anexos do documento PDF usando o PDF Cloud Python SDK" offSpacer="" %}}
