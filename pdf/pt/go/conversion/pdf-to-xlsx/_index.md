---
title: Converter PDF para XLSX via Cloud Go SDK
url: go/conversion/pdf-to-xlsx/
description: Exportar tabelas e conteúdo de PDF para XLSX usando Aspose.PDF Cloud SDK para Go.
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para XLSX no Go SDK" h2="Exporte documentos PDF para múltiplos formatos, incluindo XLSX com Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para XLSX Usando Go SDK" %}}

Para converter PDF para XLSX, usaremos
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
Este Cloud SDK auxilia programadores Go no desenvolvimento de aplicativos criadores, anotadores, editores e conversores de PDF baseados em nuvem, usando a linguagem de programação Go via API REST Aspose.PDF. Use o seguinte comando no Console do Gerenciador de Pacotes.
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PDF para XLSX via Go" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud Go podem facilmente carregar e converter PDF para XLSX com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar um arquivo PDF no Armazenamento em Nuvem Aspose.
1. Converter o PDF para o formato XLSX.
1. Salvar o XLSX de saída no armazenamento em nuvem.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para XLSX Cloud Go SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/jpeg-to-pdf/" name="JPEG PARA PDF" description="Grupo Conjunto de Peritos Fotográficos" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/pdf-to-jpeg/" name="PDF PARA JPEG" description="Grupo Conjunto de Peritos Fotográficos" >}}
