---
title: Converter PDF para XPS via Cloud Go SDK
url: go/conversion/pdf-to-xps/
description: Converta PDFs para o formato XPS usando Aspose.PDF Cloud SDK para Go. Mantenha a integridade do layout.
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para XPS no Go SDK" h2="Exporte documentos PDF para múltiplos formatos, incluindo XPS, com Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para XPS Usando Go SDK" %}}

Para converter PDF para XPS, usaremos
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
Este Cloud SDK ajuda programadores Go a desenvolver aplicativos baseados em nuvem para criar, anotar, editar e converter PDFs usando a linguagem de programação Go via Aspose.PDF REST API. Use o seguinte comando no Console do Gerenciador de Pacotes.
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PDF para XPS via Go" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud Go podem facilmente carregar e converter PDF para XPS com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar um arquivo PDF no Armazenamento em Nuvem do Aspose.
1. Converter o PDF para o formato XPS.
1. Salvar o XPS de saída no armazenamento em nuvem.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para XPS com o Cloud Go SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/cgm-to-pdf/" name="CGM PARA PDF" description="Formato Binário do Word da Microsoft" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/pdf-to-tex/" name="PDF PARA TEX" description="Sistema de Gráficos Computadorizados" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/pdf-to-xlsx/" name="PDF PARA XLSX" description="Arquivo de Formato de Planilha XML Aberto do Microsoft Excel" >}}
