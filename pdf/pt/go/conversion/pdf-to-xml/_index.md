---
title: Converter PDF para Xml via Cloud Go SDK
url: go/conversion/pdf-to-xml/
description: Converta PDFs para arquivos Xml com Go usando Aspose.PDF Cloud.
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para Xml no Go SDK" h2="Exporte documentos PDF para múltiplos formatos incluindo Xml com Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para Xml Usando Go SDK" %}}

Para converter PDF para Xml, usaremos
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
Este SDK na Nuvem auxilia programadores Go no desenvolvimento de aplicativos de criador, anotador, editor e conversor de PDF baseados em nuvem usando a linguagem de programação Go via Aspose.PDF REST API. Use o seguinte comando do Console do Gerenciador de Pacotes.
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para Converter PDF para Xml via Go" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores Aspose.PDF Cloud Go podem facilmente carregar e converter PDF para Xml em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar um arquivo PDF no Armazenamento em Nuvem da Aspose.
1. Converter o PDF para o formato XML.
1. Salvar o XML de saída no armazenamento em nuvem.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para Xml no Cloud Go SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/emf-to-pdf/" name="EMF PARA PDF" description="Documento do Microsoft Word 2007+" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/pdf-to-tiff/" name="PDF PARA TIFF" description="Formato de Imagem com Marcação" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/go/conversion/tiff-to-pdf/" name="TIFF PARA PDF" description="Formato de Imagem com Marcação" >}}
