---
title: Converter PDF para EPUB via Cloud Go SDK
url: go/conversion/pdf-to-epub/
description: Exporte arquivos PDF para o formato EPUB usando Aspose.PDF Cloud SDK para Go. Habilite layouts amigáveis para eBooks.
lastmod: 2025-05-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para EPUB no Go SDK" h2="Exporte documentos PDF para múltiplos formatos, incluindo EPUB, com Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para EPUB Usando Go SDK" %}}

Para converter PDF para EPUB, usaremos
[Aspose.PDF Cloud Go SDK](https://products.aspose.cloud/pdf/go/)
Este Cloud SDK auxilia programadores Go a desenvolver aplicativos baseados em nuvem para criação, anotação, edição e conversão de PDFs usando a linguagem de programação Go via Aspose.PDF REST API. Use o seguinte comando no Console do Gerenciador de Pacotes.
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PDF para EPUB via Go" %}}

{{% blocks/products/pf/agp/text %}}

Desenvolvedores Aspose.PDF Cloud Go podem facilmente carregar e converter PDF para EPUB em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar um arquivo PDF para o Armazenamento em Nuvem Aspose.
1. Converter o PDF para o formato EPUB.
1. Salvar o EPUB de saída no armazenamento em nuvem.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para EPUB no Cloud Go SDK" offSpacer="" %}}
