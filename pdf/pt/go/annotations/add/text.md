---
title: Adicionar Anotações de Texto via Cloud Go SDK
url: go/annotations/text/
description: Adicione Anotações de Texto a PDFs usando Aspose.PDF Cloud SDK para Go.
lastmod: 2025-07-20
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Adicionar Anotações de Texto ao PDF via Go SDK" h2="API para adicionar anotações a documentos PDF com Aspose.PDF Cloud Go SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-go.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
1. Definir Estilo de Texto (Tamanho da Fonte, Fonte, Primeiro Plano, Fundo).
1. Compor o Objeto de Anotação com FreeTextAnnotation.
1. Postar a Anotação na Página do PDF.
1. Baixar o documento modificado se bem-sucedido.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este exemplo de código mostra como adicionar anotações de Texto Livre ao documento PDF usando PDF Cloud Go SDK" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Trabalhe com as anotações no PDF via Go SDK" %}}
...
{{< blocks/products/pf/slr-tab tabTitle="Por que escolher o Aspose.PDF Cloud para Go?" tabId="success-stories" >}}
