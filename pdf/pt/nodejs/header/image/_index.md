---
title: Adicionar Imagem no Cabeçalho do PDF via Cloud Node.js SDK
url: nodejs/header/image/
description: Adicione cabeçalhos de imagem a PDFs em Node.js com Aspose.PDF Cloud. Automatize a formatação de relatórios.
lastmod: 2025-02-20
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Adicionar Imagem ao Cabeçalho do PDF no Node.js SDK" h2="Adicionar Imagem no Cabeçalho do Documento PDF usando Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
1. Realize a recuperação dos links de anotações do documento PDF usando a função getPageLinkAnnotations()
...
{{% blocks/products/pf/agp/content h2="Trabalhe com o Cabeçalho via Node.js SDK" %}}

Adicionar uma imagem ao cabeçalho de um PDF melhora a marca, o profissionalismo, a legibilidade e a segurança. Isso garante consistência em documentos empresariais, legais, de marketing e técnicos, tornando-os mais visualmente atraentes e funcionais.
...
+ Você pode experimentar nossas [Apps gratuitas](https://products.aspose.app/pdf/family/) para testar a funcionalidade online.
