---
title: Converter PDF para PDF/A via Cloud Node.js SDK
url: nodejs/conversion/pdf-to-pdfa/
description: Arquive PDFs no formato PDF/A usando Aspose.PDF Cloud SDK para Node.js. Garanta conformidade a longo prazo.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para PDF/A no Node.js SDK" h2="Exporte documentos PDF para múltiplos formatos, incluindo PDF/A com Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para PDF/A Usando Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PDF para PDF/A via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud Node.js podem facilmente carregar e converter arquivos PDF para PDF/A em apenas algumas linhas de código.
...
1. Realize a conversão usando getPdfInStorageToPdfA
1. Baixe o resultado se necessário

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para PDF/A Cloud Node.js SDK" offSpacer="" %}}
