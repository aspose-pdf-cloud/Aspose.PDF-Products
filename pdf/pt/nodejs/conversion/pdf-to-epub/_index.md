---
title: Converter PDF para EPUB via Cloud Node.js SDK
url: nodejs/conversion/pdf-to-epub/
description: Exporte arquivos PDF para o formato EPUB usando Aspose.PDF Cloud SDK para Node.js. Ative layouts amigáveis para eBooks.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para EPUB no Node.js SDK" h2="Exporte documentos PDF para múltiplos formatos incluindo EPUB com Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para EPUB Usando Node.js SDK" %}}

Para converter PDF para EPUB, usaremos
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Este Cloud SDK auxilia programadores Node.js no desenvolvimento de aplicativos de criador, anotador, editor e conversor de PDF baseados em nuvem usando a linguagem de programação Node.js via Aspose.PDF REST API. Abra
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PDF para EPUB via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud Node.js podem facilmente carregar e converter arquivos PDF para EPUB em apenas algumas linhas de código.
...
1. Realize a conversão usando getPdfInStorageToEpub
1. Baixe o resultado se necessário

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para EPUB Cloud Node.js SDK" offSpacer="" %}}
