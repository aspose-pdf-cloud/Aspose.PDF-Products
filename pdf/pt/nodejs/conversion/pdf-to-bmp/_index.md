---
title: Converter PDF para BMP via Cloud Node.js SDK
url: nodejs/conversion/pdf-to-bmp/
description: Converta PDF para formato de imagem BMP com Aspose.PDF Cloud SDK para Node.js. Saída de imagem em alta resolução.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para BMP no Node.js SDK" h2="Exporte documentos PDF para múltiplos formatos, incluindo BMP com Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para BMP Usando Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para Converter PDF para BMP via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores Aspose.PDF Cloud Node.js podem facilmente carregar e converter arquivos PDF para BMP em apenas algumas linhas de código.
...
1. Carregue o arquivo do documento
1. Realize a conversão usando getPageConvertToBmp
1. Baixe o resultado se necessário

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para BMP Cloud Node.js SDK" offSpacer="" %}}
