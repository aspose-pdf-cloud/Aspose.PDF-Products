---
title: Converter PDF para SVG via Cloud Node.js SDK
url: nodejs/conversion/pdf-to-svg/
description: Exporte conteúdo de PDF para imagens vetoriais SVG usando Node.js e Aspose.PDF Cloud SDK.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para SVG no Node.js SDK" h2="Exporte documentos PDF para múltiplos formatos incluindo SVG com Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para SVG Usando Node.js SDK" %}}

Para converter PDF para SVG, usaremos
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Este SDK Cloud auxilia programadores Node.js a desenvolver aplicativos criadores, anotadores, editores e conversores de PDF baseados em nuvem usando a linguagem de programação Node.js via Aspose.PDF REST API. Abra
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PDF para SVG via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores Aspose.PDF Cloud Node.js podem facilmente carregar e converter arquivos PDF para SVG com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue seu Segredo de Aplicação e Chave do arquivo JSON ou defina as credenciais de outra forma
1. Crie um objeto para se conectar à API Cloud
1. Faça o upload do seu arquivo de documento
1. Realize a conversão usando getPdfInStorageToSvg
1. Faça o download do resultado, se necessário

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de PDF para SVG no Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/emf-to-pdf/" name="EMF PARA PDF" description="Documento do Office 2007+ Word" >}}
