---
title: Converter PS para PDF via Cloud Node.js SDK
weight: 2710
url: nodejs/conversion/ps-to-pdf/
description: Converta arquivos PostScript (PS) em PDFs usando Aspose.PDF Cloud SDK para Node.js.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PS para PDF no Node.js SDK" h2="Exporte documentos PS para múltiplos formatos, incluindo PDF, com Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PS para PDF Usando Node.js SDK" %}}

Para converter PS para PDF, usaremos
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Este Cloud SDK ajuda programadores Node.js a desenvolverem aplicativos de criação, anotação, edição e conversão de PDFs baseados em nuvem usando a linguagem de programação Node.js via Aspose.PDF REST API. Abra
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PS para PDF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Desenvolvedores Aspose.PDF Cloud Node.js podem facilmente carregar e converter arquivos PS para PDF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue seu Segredo de Aplicação e Chave do arquivo JSON ou configure credenciais de outra maneira
1. Crie um objeto para conectar à API da Nuvem
1. Carregue seu arquivo de documento
1. Realize a conversão usando putPsInStorageToPdf
1. Baixe o resultado, se necessário

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão do Cloud Node.js SDK de PS para PDF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/jpeg-to-pdf/" name="JPEG PARA PDF" description="Joint Photographic Experts Group" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-tex/" name="PDF PARA TEX" description="Sistema de Gráficos Computadorizados" >}}
