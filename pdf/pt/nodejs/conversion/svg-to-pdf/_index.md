---
title: Converter SVG para PDF via Cloud Node.js SDK
url: nodejs/conversion/svg-to-pdf/
description: Renderize gráficos SVG em documentos PDF usando Aspose.PDF Cloud SDK em Node.js.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter SVG para PDF no Node.js SDK" h2="Exporte documentos SVG para múltiplos formatos, incluindo PDF, com Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter SVG para PDF Usando Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para Converter SVG para PDF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud Node.js podem facilmente carregar e converter arquivos SVG para PDF com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de SVG para PDF Cloud Node.js SDK" offSpacer="" %}}
