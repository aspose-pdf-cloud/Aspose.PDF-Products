---
title: Converter PDF para TIFF via Cloud Node.js SDK
url: nodejs/conversion/pdf-to-tiff/
description: Transforme PDFs em imagens TIFF usando o Aspose.PDF Cloud SDK para Node.js. Ideal para formatos de arquivamento e digitalização.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para TIFF no Node.js SDK" h2="Exporte documentos PDF para múltiplos formatos incluindo TIFF com Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter PDF para TIFF Usando Node.js SDK" %}}

Para converter PDF para TIFF, usaremos
[Aspose.PDF Cloud Node.js SDK](https://products.aspose.cloud/pdf/nodejs/)
Este Cloud SDK auxilia programadores Node.js no desenvolvimento de aplicativos baseados em nuvem para criação, anotação, edição e conversão de PDFs usando a linguagem de programação Node.js via Aspose.PDF REST API. Abra
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter PDF para TIFF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud Node.js podem facilmente carregar e converter arquivos PDF para TIFF com apenas algumas linhas de código.
...
1. Realize a conversão usando getPageConvertToTiff
1. Baixe o resultado se necessário

{{% /blocks/products/pf/agp/feature-section-col %}}


{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de PDF para TIFF Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF PARA XLSX" description="Arquivo de Planilha no Formato XML Aberto do Microsoft Excel" >}}
