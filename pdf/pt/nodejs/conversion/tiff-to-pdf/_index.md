---
title: Converter TIFF para PDF via Cloud Node.js SDK
url: nodejs/conversion/tiff-to-pdf/
description: Converter arquivos de imagem TIFF para PDF com Node.js usando Aspose.PDF Cloud SDK.
lastmod: 2022-03-17
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter TIFF para PDF no Node.js SDK" h2="Exportar documentos TIFF para vários formatos, incluindo PDF, com Aspose.PDF Cloud Node.js SDK" logoImageSrc="https://products.aspose.cloud/headers/aspose_pdf-for-node.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter TIFF para PDF Usando o Node.js SDK" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Converter TIFF para PDF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores do Aspose.PDF Cloud Node.js podem facilmente carregar e converter arquivos TIFF para PDF com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue seu Application Secret e Key do arquivo JSON ou defina as credenciais de outra forma
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a Conversão de TIFF para PDF Cloud Node.js SDK" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/emf-to-pdf/" name="EMF PARA PDF" description="Documento de Palavras do Office 2007+" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-png/" name="PDF PARA PNG" description="Gráficos de Rede Portátil" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/pdf-to-xlsx/" name="PDF PARA XLSX" description="Arquivo de Planilha no Formato Aberto XML do Microsoft Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.cloud/pdf/nodejs/conversion/png-to-pdf/" name="PNG PARA PDF" description="Gráficos de Rede Portátil" >}}
