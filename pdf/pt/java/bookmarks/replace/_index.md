...
{{% blocks/products/pf/agp/content h2="Como substituir Marcador via SDK Java na Nuvem " %}}

Para substituir um Marcador via SDK Java na Nuvem, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para substituir um Marcador via SDK Java" %}}
...
1. Defina a propriedade desejada usando a função putBookmark
1. Verifique a resposta e registre o resultado
1. Baixe o arquivo atualizado para uso local

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Este código de exemplo demonstra a substituição de um Marcador em documentos PDF" offSpacer="" %}}
